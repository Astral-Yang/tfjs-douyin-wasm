...
! function(e, t) {
	...
	function t(e, t) {
		return t.forEach((function(t) {
			t && "string" != typeof t && !Array.isArray(t) && Object.keys(t).forEach((function(
				n) {
				if ("default" !== n && !(n in e)) {
				...
				return function(o) {
					...
					for (; i;) try {
						if (n = 1, r && (a = 2 & o[0] ? r.return : o[0] ? r.throw || ((a = r
								.return) && a.call(r), 0) : r.next) && !(a = a.call(r, o[1]))
							.done)
							return a;
						switch (r = 0, a && (o = [2 & o[0], a.value]), o[0]) {
							...
							case 7:
								...
								continue;
							default:
								if (!(a = i.trys, (a = a.length > 0 && a[a.length - 1]) || 6 !==
										o[
											0] && 2 !== o[0])) {
									i = 0;
									continue
	...
	function u(e, t, n) {
		if (n || 2 === arguments.length)
			for (var r, a = 0, o = t.length; a < o; a++) !r && a in t || (r || (r = Array.prototype.slice
				.call(
					t, 0, a)), r[a] = t[a]);
	...
	function f(e) {
		for (var t = e.length, n = 0; t > 0;) n = Math.random() * t | 0, p(e, --t, n)
	}
	...
	function E(e, t) {
		var n = t.length;
		return g((e = null == e ? t.map((function(e, t) {
			return t
	...
	function S(e, t) {
		for (var n = [], r = [], a = null != t && Array.isArray(t) && 0 === t.length, o = null == t || a ?
				null : E(t, e).sort(), i = 0, s = 0; s < e.length; ++s) {
			if (null != o) {
				if (o[i] === s && 1 !== e[s]) throw new Error("Can't squeeze axis ".concat(s,
					" since its dim '").concat(e[s], "' is not 1"));
				(null == o[i] || o[i] > s) && 1 === e[s] && (n.push(e[s]), r.push(s)), o[i] <= s && i++
			}
	...
	function F(e) {
		return Array.isArray(e) ? F(e[0]) : e instanceof Float32Array ? "float32" :
			e instanceof Int32Array ||
			e instanceof Uint8Array || e instanceof Uint8ClampedArray ? "int32" : B(e) ? "float32" : D(e) ?
			"string" : R(e) ? "bool" : "float32"
	}
	...
	function z(e, t, n) {
		...
		if (0 === r) return [];
		if (r !== t.length) throw new Error("[".concat(e, "] does not match the input size ").concat(t
				.length)
		...
		H = function() {
			function e(e) {
				this.global = e, this.flags = {}, this.flagRegistry = {}, this.urlFlags = {}, this
					.getQueryParams = j, this.populateURLFlags()
			}
			return e.prototype.setPlatform = function(e, t) {
				null != this.platform && (Z().getBool("IS_TEST") || Z().getBool("PROD") || console.warn(
				...
				if (this.flagRegistry[e] = {
					...
					Z().getBool("IS_TEST") || Z().getBool("PROD") || console.warn(
							"Setting feature override from URL ".concat(e, ": ").concat(r, ".")), this
						.set(
							e, r)
				}
				...
				return a(this, void 0, void 0, (function() {
					...
					return o(this, (function(r) {
						switch (r.label) {
							case 0:
								return e in this.flags ? [2, this.flags[e]] : (
									t =
									this.flags, n = e, [4, this
										.evaluateFlag(e)
									]
								);
							case 1:
				...
				if (q(t)) throw new Error("Flag ".concat(e, " cannot be synchronously evaluated. ") +
				...
				this.flags[e] = t, null != this.flagRegistry[e].setHook && this.flagRegistry[e].setHook(
					t)
				...
				if ("undefined" != typeof this.global && "undefined" != typeof this.global.location &&
					...
					if (V in t) t.tfjsflags.split(",").forEach((function(t) {
						var n = s(t.split(":"), 2),
							r = n[0],
							a = n[1];
						e.urlFlags[r] = function(e, t) {
							var n = t.toLowerCase();
							return "true" === n || "false" === n ? "true" === n : ""
								.concat(
									+n) === n ? +n : t
						}(0, a)
					}))
	...
	function X(e, t) {
		var n, r = (null == (n = Y())._tfGlobals && (n._tfGlobals = new Map), n._tfGlobals);
	...
	function Bn() {
		...
		Z().getBool("IS_TEST") || Z().getBool("PROD") || console.warn.apply(console, u([], s(e), !1))
	}
	...
	function zn(e) {
		var t = e.kernelName,
			n = e.backendName,
			r = Un(t, n);
		Fn.has(r) && Bn("The kernel '".concat(t, "' for backend ") + "'".concat(n,
	...
	var Gn = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window :
	...
	var Kn = Hn,
		Vn = null;
	try {
		Vn = new WebAssembly.Instance(new WebAssembly.Module(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1,
			13,
			2, 96, 0, 1, 127, 96, 4, 127, 127, 127, 127, 1, 127, 3, 7, 6, 0, 1, 1, 1, 1, 1,
			6,
			6, 1, 127, 1, 65, 0, 11, 7, 50, 6, 3, 109, 117, 108, 0, 1, 5, 100, 105, 118, 95,
			115, 0, 2, 5, 100, 105, 118, 95, 117, 0, 3, 5, 114, 101, 109, 95, 115, 0, 4, 5,
			114,
			101, 109, 95, 117, 0, 5, 8, 103, 101, 116, 95, 104, 105, 103, 104, 0, 0, 10,
			191, 1,
			6, 4, 0, 35, 0, 11, 36, 1, 1, 126, 32, 0, 173, 32, 1, 173, 66, 32, 134, 132, 32,
			2,
			173, 32, 3, 173, 66, 32, 134, 132, 126, 34, 4, 66, 32, 135, 167, 36, 0, 32, 4,
			167,
			11, 36, 1, 1, 126, 32, 0, 173, 32, 1, 173, 66, 32, 134, 132, 32, 2, 173, 32, 3,
			173,
			...
			173,
			32, 1, 173, 66, 32, 134, 132, 32, 2, 173, 32, 3, 173, 66, 32, 134, 132, 129, 34,
			4,
			66, 32, 135, 167, 36, 0, 32, 4, 167, 11, 36, 1, 1, 126, 32, 0, 173, 32, 1, 173,
			66,
	...
	Hn.prototype.__isLong__, Object.defineProperty(Hn.prototype, "__isLong__", {
		value: !0
	}), Hn.isLong = jn;
	var Jn = {},
		Zn = {};
	...
	function Yn(e, t) {
		var n, r, a;
		return t ? (a = 0 <= (e >>>= 0) && e < 256) && (r = Zn[e]) ? r : (n = Qn(e, (0 | e) < 0 ? -1 : 0, !
				0),
			a && (Zn[e] = n), n) : (a = -128 <= (e |= 0) && e < 128) && (r = Jn[e]) ? r : (n = Qn(e, e <
			0 ?
			-1 : 0, !1), a && (Jn[e] = n), n)
	}
	...
	function er(e, t, n) {
		...
		if ("NaN" === e || "Infinity" === e || "+Infinity" === e || "-Infinity" === e) return ir;
	...
	function tr(e, t) {
		return "number" == typeof e ? Xn(e, t) : "string" == typeof e ? er(e, t) : Qn(e.low, e.high,
	...
	pr.toInt = function() {
		...
		return this.unsigned ? (this.high >>> 0) * nr + (this.low >>> 0) : this.high * nr + (this
			.low >>> 0)
		...
		if (this.isNegative()) return this.eq(dr) ? 64 : this.neg().getNumBitsAbs();
		for (var e = 0 != this.high ? this.high : this.low, t = 31; t > 0 && 0 == (e & 1 << t); t--);
		return 0 != this.high ? t + 33 : t + 1
	}, pr.isZero = function() {
		return 0 === this.high && 0 === this.low
	}, pr.eqz = pr.isZero, pr.isNegative = function() {
		...
		return jn(e) || (e = tr(e)), (this.unsigned === e.unsigned || this.high >>> 31 != 1 || e
			.high >>>
			31 != 1) && (this.high === e.high && this.low === e.low)
	}, pr.eq = pr.equals, pr.notEquals = function(e) {
		return !this.eq(e)
	}, pr.neq = pr.notEquals, pr.ne = pr.notEquals, pr.lessThan = function(e) {
		return this.comp(e) < 0
	}, pr.lt = pr.lessThan, pr.lessThanOrEqual = function(e) {
		return this.comp(e) <= 0
	}, pr.lte = pr.lessThanOrEqual, pr.le = pr.lessThanOrEqual, pr.greaterThan = function(e) {
		return this.comp(e) > 0
	}, pr.gt = pr.greaterThan, pr.greaterThanOrEqual = function(e) {
		return this.comp(e) >= 0
	}, pr.gte = pr.greaterThanOrEqual, pr.ge = pr.greaterThanOrEqual, pr.compare = function(e) {
	...
	}, pr.comp = pr.compare, pr.negate = function() {
		return !this.unsigned && this.eq(dr) ? dr : this.not().add(ur)
	}, pr.neg = pr.negate, pr.add = function(e) {
		jn(e) || (e = tr(e));
		var t = this.high >>> 16,
			n = 65535 & this.high,
			r = this.low >>> 16,
			...
			l = 0,
			h = 0;
		return l += (h += a + (65535 & e.low)) >>> 16, c += (l += r + s) >>> 16, u += (c += n + i) >>>
			16,
			u += t + o, Qn((l &= 65535) << 16 | (h &= 65535), (u &= 65535) << 16 | (c &= 65535), this
				.unsigned)
	}, pr.subtract = function(e) {
		return jn(e) || (e = tr(e)), this.add(e.neg())
	}, pr.sub = pr.subtract, pr.multiply = function(e) {
		if (this.isZero()) return ir;
		if (jn(e) || (e = tr(e)), Vn) return Qn(Vn.mul(this.low, this.high, e.low, e.high), Vn
			.get_high(),
			this.unsigned);
		if (e.isZero()) return ir;
		if (this.eq(dr)) return e.isOdd() ? dr : ir;
		if (e.eq(dr)) return this.isOdd() ? dr : ir;
		if (this.isNegative()) return e.isNegative() ? this.neg().mul(e.neg()) : this.neg().mul(e)
	.neg();
		if (e.isNegative()) return this.mul(e.neg()).neg();
		if (this.lt(or) && e.lt(or)) return Xn(this.toNumber() * e.toNumber(), this.unsigned);
		var t = this.high >>> 16,
			n = 65535 & this.high,
			r = this.low >>> 16,
			a = 65535 & this.low,
			...
			h = 0,
			f = 0;
		return h += (f += a * u) >>> 16, l += (h += r * u) >>> 16, h &= 65535, l += (h += a * s) >>> 16,
			c += (l += n * u) >>> 16, l &= 65535, c += (l += r * s) >>> 16, l &= 65535, c += (l += a *
				i) >>> 16, c += t * u + n * s + r * i + a * o, Qn((h &= 65535) << 16 | (f &= 65535), (
				c &=
				65535) << 16 | (l &= 65535), this.unsigned)
	}, pr.mul = pr.multiply, pr.divide = function(e) {
		if (jn(e) || (e = tr(e)), e.isZero()) throw Error("division by zero");
		var t, n, r;
		if (Vn) return this.unsigned || -2147483648 !== this.high || -1 !== e.low || -1 !== e.high ? Qn(
			(
				this.unsigned ? Vn.div_u : Vn.div_s)(this.low, this.high, e.low, e.high), Vn
		...
		if (this.unsigned) {
			...
			if (this.eq(dr)) return e.eq(ur) || e.eq(lr) ? dr : e.eq(dr) ? ur : (t = this.shr(1).div(e)
				.shl(
					1)).eq(ir) ? e.isNegative() ? ur : lr : (n = this.sub(e.mul(t)), r = t.add(n
				.div(
					e)));
		...
		for (n = this; n.gte(e);) {
			...
			for (var a = Math.ceil(Math.log(t) / Math.LN2), o = a <= 48 ? 1 : $n(2, a - 48), i = Xn(t),
					s =
					i.mul(e); s.isNegative() || s.gt(n);) s = (i = Xn(t -= o, this.unsigned)).mul(e);
			i.isZero() && (i = ur), r = r.add(i), n = n.sub(s)
		}
		return r
	}, pr.div = pr.divide, pr.modulo = function(e) {
		return jn(e) || (e = tr(e)), Vn ? Qn((this.unsigned ? Vn.rem_u : Vn.rem_s)(this.low, this.high,
			e
			.low, e.high), Vn.get_high(), this.unsigned) : this.sub(this.div(e).mul(e))
	}, pr.mod = pr.modulo, pr.rem = pr.modulo, pr.not = function() {
		return Qn(~this.low, ~this.high, this.unsigned)
	}, pr.and = function(e) {
		return jn(e) || (e = tr(e)), Qn(this.low & e.low, this.high & e.high, this.unsigned)
	}, pr.or = function(e) {
		return jn(e) || (e = tr(e)), Qn(this.low | e.low, this.high | e.high, this.unsigned)
	}, pr.xor = function(e) {
		return jn(e) || (e = tr(e)), Qn(this.low ^ e.low, this.high ^ e.high, this.unsigned)
	}, pr.shiftLeft = function(e) {
		return jn(e) && (e = e.toInt()), 0 == (e &= 63) ? this : e < 32 ? Qn(this.low << e, this.high <<
			e |
			this.low >>> 32 - e, this.unsigned) : Qn(0, this.low << e - 32, this.unsigned)
	}, pr.shl = pr.shiftLeft, pr.shiftRight = function(e) {
		return jn(e) && (e = e.toInt()), 0 == (e &= 63) ? this : e < 32 ? Qn(this.low >>> e | this
			.high <<
			32 - e, this.high >> e, this.unsigned) : Qn(this.high >> e - 32, this.high >= 0 ? 0 : -
			1,
			this.unsigned)
	}, pr.shr = pr.shiftRight, pr.shiftRightUnsigned = function(e) {
		if (jn(e) && (e = e.toInt()), 0 === (e &= 63)) return this;
		var t = this.high;
		return e < 32 ? Qn(this.low >>> e | t << 32 - e, t >>> e, this.unsigned) : Qn(32 === e ? t :
			t >>>
			e - 32, 0, this.unsigned)
	}, pr.shru = pr.shiftRightUnsigned, pr.shr_u = pr.shiftRightUnsigned, pr.toSigned = function() {
		...
		var e = this.high,
			t = this.low;
		return [255 & t, t >>> 8 & 255, t >>> 16 & 255, t >>> 24, 255 & e, e >>> 8 & 255, e >>> 16 &
			255,
			e >>> 24
		]
		...
		var e = this.high,
			t = this.low;
		return [e >>> 24, e >>> 16 & 255, e >>> 8 & 255, 255 & e, t >>> 24, t >>> 16 & 255, t >>> 8 &
			255,
			255 & t
		]
		...
		return new Hn(e[0] | e[1] << 8 | e[2] << 16 | e[3] << 24, e[4] | e[5] << 8 | e[6] << 16 | e[
			7] <<
			24, t)
	}, Hn.fromBytesBE = function(e, t) {
		return new Hn(e[4] << 24 | e[5] << 16 | e[6] << 8 | e[7], e[0] << 24 | e[1] << 16 | e[2] << 8 |
			e[
				3], t)
	};
	var gr = qn(Kn),
	...
	function Ir(e, t, n, r) {
		return function(e, t, n, r, a, o) {
			...
			var i = a;
			return a = (a = a.add(t)).add(n), o = o.add(Ar(a, 44)), [a.add(r), o.add(i)]
		}(Er(e, t), Er(e, t + 8), Er(e, t + 16), Er(e, t + 24), n, r)
	}

	function Nr(e, t) {
		if ("string" === t) throw new Error("Cannot convert a string[] to a TypedArray");
		if (Array.isArray(e) && (e = Br(e)), Z().getBool("DEBUG") && I(e, t), function(e, t) {
				return e instanceof Float32Array && "float32" === t || e instanceof Int32Array &&
					"int32" ===
		...
		if ("int32" === t) return new Int32Array(e);
		if ("bool" === t) {
			for (var n = new Uint8Array(e.length), r = 0; r < n.length; ++r) 0 !== Math.round(e[r]) && (n[
				r] =
				1);
			return n
		}
	...
	function Tr(e, t) {
		return void 0 === t && (t = "utf-8"), t = t || "utf-8", Z().platform.encode(e, t)
	}

	function Dr(e, t) {
		return void 0 === t && (t = "utf-8"), t = t || "utf-8", Z().platform.decode(e, t)
	}

	function Rr(e) {
		return null != Z().platform.isTypedArray ? Z().platform.isTypedArray(e) : Wn(e)
	}

	function Br(e, t, n) {
		var r, a;
		if (void 0 === t && (t = []), void 0 === n && (n = !1), null == t && (t = []), "boolean" ==
			typeof e ||
			"number" == typeof e || "string" == typeof e || q(e) || null == e || Rr(e) && n) t.push(e);
	...
	var Fr = {
			...
			encodeString: Tr,
			fetch: function(e, t) {
				return TTWebAssembly.fetch(e, t)
			},
			fingerPrint64: function(e, t) {
				var n, r;
				void 0 === t && (t = e.length);
				var a = vr.fromNumber(81, !0);
				if (t <= 32) return t <= 16 ? function(e, t) {
					if (void 0 === t && (t = e.length), t >= 8) {
						var n = wr.add(2 * t),
							r = Er(e, 0).add(wr);
						return _r(Ar(a = Er(e, t - 8), 37).mul(n).add(r), Ar(r, 25).add(a).mul(
								n),
							n)
					}
					if (t >= 4) return n = wr.add(2 * t), _r((r = Sr(e, 0)).shl(3).add(t), Sr(e,
						t -
						4), n);
					if (t > 0) {
						var a, o = (r = e[0]) + ((a = e[t >> 1]) << 8),
							i = t + (e[t - 1] << 2);
					...
					var n = wr.add(2 * t),
						...
						o = Er(e, t - 8).mul(n),
						i = Er(e, t - 16).mul(wr);
					return _r(Ar(r.add(a), 43).add(Ar(o, 30)).add(i), r.add(Ar(a.add(wr), 18))
						.add(
							o), n)
				}(e, t);
				if (t <= 64) return function(e, t) {
					void 0 === t && (t = e.length);
					var n = wr.add(2 * t),
						r = Er(e, 0).mul(wr),
						a = Er(e, 8),
					...
					return _r(Ar(c.add(l), 43).add(Ar(h, 30)).add(f), c.add(Ar(l.add(r), 18))
						.add(
							h), n)
				}(e, t);
				var o = a,
				...
				var h = 0,
					...
					d = f + (t - 1 & 63) - 63;
				do {
					o = Ar(o.add(i).add(c[0]).add(Er(e, h + 8)), 37).mul(br), i = Ar(i.add(c[1]).add(Er(
							e,
							h + 48)), 42).mul(br), o = o.xor(l[1]), i = i.add(c[0]).add(Er(e, h + 40)),
						u =
						Ar(u.add(l[0]), 33).mul(br), c = Ir(e, h, c[1].mul(br), o.add(l[0])), l = Ir(e,
							h +
							32, u.add(l[1]), i.add(Er(e, h + 16))), u = (n = s([o, u], 2))[0], o = n[1],
						h += 64
				} while (h !== f);
				var p = br.add(u.and(255).shl(1));
				return h = d, l[0] = l[0].add(t - 1 & 63), c[0] = c[0].add(l[0]), l[0] = l[0].add(c[0]),
					o =
					Ar(o.add(i).add(c[0]).add(Er(e, h + 8)), 37).mul(p), i = Ar(i.add(c[1]).add(Er(e,
						h +
						48)), 42).mul(p), o = o.xor(l[1].mul(9)), i = i.add(c[0].mul(9).add(Er(e, h +
						40))),
					u = Ar(u.add(l[0]), 33).mul(p), c = Ir(e, h, c[1].mul(p), o.add(l[0])), l = Ir(e,
						h +
						32, u.add(l[1]), i.add(Er(e, h + 16))), u = (r = s([o, u], 2))[0], o = r[1], _r(
						_r(
							c[0], l[0], p).add(kr(i).mul(yr)).add(u), _r(c[1], l[1], p).add(o), p)
			},
			flatten: Br,
			getArrayFromDType: _,
			getTypedArrayFromDType: A,
			hasEncodingLoss: function(e, t) {
				return "complex64" !== t && (("float32" !== t || "complex64" === e) && (("int32" !==
					t ||
					"float32" === e || "complex64" === e) && ("bool" !== t || "bool" !== e)))
			},
			hexToLong: mr,
			indexToLoc: function(e, t, n) {
				if (0 === t) return [];
				if (1 === t) return [e];
				for (var r = new Array(t), a = 0; a < r.length - 1; ++a) r[a] = Math.floor(e / n[a]),
					e -=
					r[a] * n[a];
			...
			inferFromImplicitShape: function(e, t) {
				for (var n = 1, r = -1, a = 0; a < e.length; ++a)
					...
					if (-1 !== r) throw Error("Shapes can only have 1 implicit size. " +
						"Found -1 at dim "
						.concat(r, " and dim ").concat(a));
					r = a
				} else if (e[a] < 0) throw Error("Shapes can not be < 0. Found ".concat(e[a],
						" at dim ")
					.concat(a));
				if (-1 === r) {
					if (t > 0 && t !== n) throw Error("Size(".concat(t,
						") must match the product of shape ").concat(e));
					return e
				}
				if (0 === n) throw Error("Cannot infer the missing size in [".concat(e, "] when ") +
					"there are 0 elements");
				if (t % n != 0) throw Error("The implicit shape can't be a fractional number. " + "Got "
					.concat(t, " / ").concat(n));
				var o = e.slice();
				return o[r] = t / n, o
			},
			...
			shuffleCombo: function(e, t) {
				if (e.length !== t.length) throw new Error(
					"Array sizes must match to be shuffled together " +
					"First array length was "
					.concat(e.length) + "Second array length was ".concat(t.length));
				for (var n = e.length, r = 0; n > 0;) r = Math.random() * n | 0, p(e, --n, r), p(t, n,
					r)
			},
			sizeFromShape: y,
		...
		Cr = function() {
			function e(e, t) {
				this.backendTimer = e, this.logger = t, null == t && (this.logger = new Pr)
			}
			return e.prototype.profileKernel = function(e, t, n) {
				var r, a, o, s, u = function() {
						o = n()
					},
					c = Mr();
							...
							n.data().then((function(t) {
								! function(e, t, n) {
									...
									for (var r = 0; r < e.length; r++) {
										var a = e[r];
										if (isNaN(a) || !isFinite(a)) return console
											.warn(
												"Found ".concat(a,
			...
			for (var f in a) {
				...
				if (null != d) {
					var p = d.shape || t.shape,
						g = p.length;
					h += "".concat(f, ": ").concat(g, "D ").concat(g > 0 ? p : "", " ")
				}
			}
			console.log("%c".concat(s, "\t%c").concat(i, "\t%c").concat(u, "D ").concat(l, "\t%c")
				.concat(c, "\t%c").concat(h, "\t%c").concat(o), "font-weight:bold", "color:red",
	...
	function Or(e, t, n, r) {
		var a = O(t),
			o = function(e, t, n, r) {
				...
				if (s > 1)
					for (var c = 0; c < a / o; c++)
						for (var l = c * o, h = 0; h < o; h++) i[h] = Math.max(i[h], Lr(u[l + h], 0, n)
							.length);
				return i
			}(e, t, n, a),
			i = t.length,
			s = Ur(e, t, n, a, o),
			u = ["Tensor"];
		return r && (u.push("  dtype: ".concat(n)), u.push("  rank: ".concat(i)), u.push("  shape: ["
			.concat(t,
				"]")), u.push("  values:")), u.push(s.map((function(e) {
			return "    " + e
		})).join("\n")), u.join("\n")
	}

	function Lr(e, t, n) {
		return x(Array.isArray(e) ? "".concat(parseFloat(e[0].toFixed(7)), " + ") + "".concat(parseFloat(e[
				1]
			.toFixed(7)), "j") : D(e) ? "'".concat(e, "'") : "bool" === n ? zr(e) : parseFloat(e
	...
	function Ur(e, t, n, r, a, o) {
		...
		var i = "complex64" === n ? 2 : 1,
			c = t[0],
			l = t.length;
		if (0 === l) return "complex64" === n ? [Lr(Wr(e)[0], 0, n)] : "bool" === n ? [zr(e[0])] : [e[0]
			.toString()
		];
		if (1 === l) {
			if (c > 20) {
				...
				return "complex64" === n && (f = Wr(f), d = Wr(d)), ["[" + f.map((function(e, t) {
					return Lr(e, a[t], n)
				})).join(", ") + ", ..., " + d.map((function(e, t) {
					return Lr(e, a[c - 3 + t], n)
				})).join(", ") + "]"]
			}
			return ["[" + ("complex64" === n ? Wr(e) : Array.from(e)).map((function(e, t) {
				return Lr(e, a[t], n)
			})).join(", ") + "]"]
		}
		var p = t.slice(1),
		...
		if (c > 20) {
			...
			for (y = c - 3; y < c; y++) {
				b = (w = y * v) + v;
				m.push.apply(m, u([], s(Ur(e.slice(w, b), p, n, g, a, y === c - 1)), !1))
			}
		} else
			for (y = 0; y < c; y++) {
				var w;
	...
	var Gr = function() {
			function e(e, t, n) {
				var r = this;
				if (this.dtype = t, this.shape = e.slice(), this.size = y(e), null != n) {
					var a = n.length;
			...
			return e.prototype.set = function(e) {
				...
				0 === n.length && (n = [0]), g(n.length === this.rank, (function() {
					return "The number of provided coordinates (".concat(n.length,
							") must ") +
				...
				try {
					for (var o = i(n), s = o.next(); !s.done; s = o.next()) {
						...
						if (u < 0 || u >= this.shape[a]) {
							var c = "Requested out of range element at ".concat(n, ". ") +
								"  Buffer shape="
								.concat(this.shape);
							throw new Error(c)
						}
				...
				for (var l = n[n.length - 1], h = 0; h < n.length - 1; ++h) l += this.strides[h] * n[h];
				...
				for (var t = new Array(this.shape.length), n = 0; n < t.length - 1; ++n) t[n] = Math
					.floor(
	...
	var Vr = function() {
		function e(e, t, n, r) {
			this.kept = !1, this.isDisposedInternal = !1, this.shape = e.slice(), this.dtype = t ||
				"float32", this.size = y(e), this.strides = O(e), this.dataId = n, this.id = r, this
		...
		return Object.defineProperty(e.prototype, "rank", {
				...
				return o(this, (function(t) {
					switch (t.label) {
						case 0:
							return [4, this.data()];
						case 1:
							return e = t.sent(), [2, Kr.buffer(this.shape,
								this
								.dtype, e)]
					}
				}))
				...
				return o(this, (function(t) {
					switch (t.label) {
						case 0:
							return [4, this.data()];
						case 1:
							return e = t.sent(), [2, z(this.shape, e,
			...
			return a(this, void 0, void 0, (function() {
				...
				return o(this, (function(n) {
					switch (n.label) {
						case 0:
							return this.throwIfDisposed(), e = qr().read(
								this
								.dataId), "string" !== this.dtype ? [3,
								2
							] : [4, e];
						case 1:
							t = n.sent();
			...
			return a(this, void 0, void 0, (function() {
				...
				return o(this, (function(t) {
					switch (t.label) {
						case 0:
							return this.throwIfDisposed(), [4, qr().read(
								this
								.dataId)];
						case 1:
							return e = t.sent(), "string" === this.dtype ? [
								2,
								e
			...
			this.isDisposed || (this.kerasMask && this.kerasMask.dispose(), qr().disposeTensor(
				this),
			...
			return void 0 === e && (e = !1), Or(this.dataSync(), this.shape, this.dtype, e)
		}, e.prototype.cast = function(e) {
			return this.throwIfDisposed(), Kr.cast(this, e)
		}, e.prototype.variable = function(e, t, n) {
			return void 0 === e && (e = !0), this.throwIfDisposed(), qr().makeVariable(this, e, t,
				n)
		}, e
	}();
	...
	var jr, Jr, Zr, Yr, Xr, Qr = function(e) {
		...
		return r(t, e), t.prototype.assign = function(e) {
			...
			if (!w(e.shape, this.shape)) throw new Error("shape of the new value (".concat(e.shape,
				") and ") + "previous value (".concat(this.shape, ") must match"));
			qr().disposeTensor(this), this.dataId = e.dataId, qr().incRef(this, null)
	...
	Object.defineProperty(Qr, Symbol.hasInstance, {
			value: function(e) {
				return e instanceof Vr && null != e.assign && e.assign instanceof Function
			}
		}), e.Rank = void 0, (jr = e.Rank || (e.Rank = {})).R0 = "R0", jr.R1 = "R1", jr.R2 = "R2", jr.R3 =
		"R3",
		jr.R4 = "R4", jr.R5 = "R5", jr.R6 = "R6",
		function(e) {
	...
	function aa(e, t) {
		g(e.dtype === t.dtype, (function() {
			return "The dtypes of the first(".concat(e.dtype, ") and") + " second(".concat(t
				.dtype,
				") input must match")
		}))
	}
	...
	var ca = function() {
			function e() {
				this.registeredVariables = {}, this.nextTapeNodeId = 0, this.numBytes = 0, this.numTensors =
					0,
					this.numStringTensors = 0, this.numDataBuffers = 0, this.gradientDepth = 0, this
					.kernelDepth = 0, this.scopeStack = [], this.numDataMovesStack = [], this.nextScopeId =
					0,
		...
		la = function() {
			function e(e) {
				this.ENV = e, this.registry = {}, this.registryFactory = {}, this.pendingBackendInitId = 0,
					this
					.state = new ca
			}
			return e.prototype.ready = function() {
				return a(this, void 0, void 0, (function() {
					...
					return o(this, (function(r) {
						switch (r.label) {
							case 0:
								if (null != this.pendingBackendInit) return [2,
									this
									.pendingBackendInit.then((
										function() {}))
								];
								if (null != this.backendInstance) return [2];
								e = this.getSortedBackends(), t = 0, r.label =
								1;
							case 1:
							...
							case 2:
								return r.sent() ? [4, this.setBackend(n)] : [3,
									4
								];
							case 3:
								return r.sent(), [2];
				...
				get: function() {
					...
					if (null == this.backendInstance) {
						var e = this.initializeBackendsAndReturnBest(),
							t = e.name;
						if (e.asyncInit) throw new Error("The highest priority backend '"
							.concat(t,
								"' has not yet been ") +
				...
				return void 0 === n && (n = 1), e in this.registryFactory ? (Bn("".concat(e,
						" backend was already registered. ") +
					"Reusing existing backend factory."), !1) : (
					...
					return o(this, (function(a) {
						switch (a.label) {
							case 0:
								...
								return this.backendName = e, null != this
									.registry[
										e] ? [3, 4] : (this.backendInstance =
										null,
							...
							case 4:
								return this.backendInstance = this.registry[e],
									...
									new Cr(this.backendInstance), [2, !0]
						}
					}))
				}))
				...
				try {
					var r = n.factory();
					if (!r || r instanceof l || "function" != typeof r.then) return this.registry[e] =
						r, {
							success: !0,
							asyncInit: !1
						};
					var a = ++this.pendingBackendInitId,
						o = r.then((function(n) {
							...
							return a < t.pendingBackendInitId || (t.pendingBackendInit = null,
								Bn(
									"Initialization of backend ".concat(e, " failed")), Bn(n
									.stack || n.message)), !1
						}));
					...
					return Bn("Initialization of backend ".concat(e, " failed")), Bn(t.stack || t
						.message), {
						success: !1,
						asyncInit: !1
					}
				...
				this.backendName === e && null != this.pendingBackendInit && this
					.pendingBackendInitId++,
					e in this.registry && (this.disposeRegisteredKernels(e), this.registry[e].dispose(),
						delete this.registry[e]), delete this.registryFactory[e], this.backendName ===
					e &&
					(this.pendingBackendInit = null, this.backendName = null, this.backendInstance =
						null)
				...
				r.disposeData(t, !0), n.backend = e, e.move(t, a, n.shape, n.dtype, o), this
					.shouldCheckForMemLeaks() && this.state.numDataMovesStack[this.state
						.numDataMovesStack
						.length - 1]++
				...
				if (null == this.backendName && this.backend, !(null != Pn(e, this.backendName)))
				...
				var o = this.state.numDataMovesStack[this.state.numDataMovesStack.length - 1],
					i = r - t - a - o;
				if (i > 0) throw new Error("Backend '".concat(this.backendName,
					"' has an internal memory leak ") + "(".concat(i,
				...
				var c = ua(e) ? e.kernelName : null != this.state.activeScope ? this.state.activeScope
					.name : "";
				if (ua(e)) {
					var l = e.kernelName,
						h = e.inputs,
					...
					g(null != d, (function() {
						return "Cannot find registered kernel '".concat(l,
								"' for backend '")
				...
				return this.scopedRun((function() {
						...
						a.ENV.getBool("DEBUG") || a.state.profiling ? (m = a.profiler
							.profileKernel(
								c, y, (function() {
									return n()
								})), a.ENV.getBool("DEBUG") && a.profiler.logKernelProfile(
								m),
							t = m.outputs) : t = n()
					})), i && this.addTapeNode(c, y, t, w, o, b), this.state.profiling && this.state
				...
				if (null != r) {
					var a = r.inputsToSave || [],
						o = r.outputsToSave || [],
						i = void 0;
					r.saveAllInputs ? (g(Array.isArray(t), (function() {
				...
				var a = e;
				"string" === n && D(e[0]) && (a = e.map((function(e) {
					return Tr(e)
				})));
				var o = r.write(a, t, n),
				...
				void 0 === t && (t = !0), n = n || this.nextVariableId().toString(), null != r && r !==
					e
					.dtype && (e = e.cast(r));
				var a = new Qr(e, t, n, this.nextTensorId());
				if (null != this.state.registeredVariables[a.name]) throw new Error(
					"Variable with name "
				...
				var n = 0;
				"complex64" !== e.dtype && "string" !== e.dtype && (n = e.size * M(e.dtype)), this.state
				...
				this.state.tensorInfo.has(e) && this.state.tensorInfo.get(e).backend === t && (this
					.state
				...
				this.disposeTensor(e), null != this.state.registeredVariables[e.name] && delete this
					.state
					.registeredVariables[e.name]
			}, e.prototype.memory = function() {
				var e = this.backend.memory();
				return e.numTensors = this.state.numTensors, e.numDataBuffers = this.state
					.numDataBuffers, e
					.numBytes = this.state.numBytes, this.state.numStringTensors > 0 && (e
						.unreliable = !0,
						...
						switch (o.label) {
							case 0:
								return this.state.profiling = !0, t = this.state
									.numBytes, n = this.state.numTensors, this
									.state
									.activeProfile.kernels = [], r = this.state
									.activeProfile, [4, e()];
							case 1:
								r.result = o.sent(), this.state.profiling = !1,
									this
									.state.activeProfile.peakBytes = Math.max
									.apply(
										Math, u([], s(this.state.activeProfile
											.kernels.map((function(e) {
												return e
													.totalBytesSnapshot
											}))), !1)), this.state.activeProfile
									.newBytes = this.state.numBytes - t, this
									.state
									.activeProfile.newTensors = this.state
									.numTensors - n, o.label = 2;
							case 2:
								o.trys.push([2, 8, 9, 10]), a = i(this.state
										.activeProfile.kernels), c = a.next(), o
									.label = 3;
							case 3:
								return c.done ? [3, 7] : (l = c.value, h = l, [
									4, l
									.kernelTimeMs
								]);
							case 4:
								return h.kernelTimeMs = o.sent(), f = l, [4, l
									.extraInfo
								];
							case 5:
				...
				0 === this.state.gradientDepth && (this.state.activeTape = []), this.state
					.gradientDepth++
				...
				for (var t = this, n = oa(e), r = new Set(n.map((function(e) {
						return e.id
				...
				this.state.activeScope = 0 === this.state.scopeStack.length ? null : this.state
					.scopeStack[
				...
				var a = this;
				if (void 0 === r && (r = !1), g(t.length > 0, (function() {
				...
				return this.tidy("backward", (function() {
					var e, r, u = {};
					u[o.id] = null == n ? (e = o.shape, r = U(y(e), "float32"), da
							.makeTensor(r,
								e, "float32")) : n,
						function(e, t, n, r) {
							for (var a = function(a) {
									...
									var s = o.gradient(i),
										u = function(t) {
											...
											var i = o.inputs[t];
											if (!w(a.shape, i.shape)) throw new Error(
												"Error in gradient for op "
												.concat(o
													.kernelName,
													". The gradient of input "
					...
					return 0 === a.state.gradientDepth && (a.state.activeTape.forEach((
						function(
							e) {
							var t, n;
							try {
								for (var r = i(e.saved), a = r.next(); !a
									.done; a =
									r.next()) {
									a.value.dispose()
								}
				...
				return g(C(e), (function() {
					...
					function() {
						...
						var i = function(t, a) {
								return g((n = e.apply(void 0, u([], s(u(u([], s(r), !1), [a], !1)), !
										1)))
									.value instanceof Vr, (function() {
				...
				return null != this.state.activeScope && (e.scopeId = this.state.activeScope.id, this
					.state
				...
				for (var e in this.pendingBackendInitId++, this.state.dispose(), this.ENV.reset(), this
						.state = new ca, this.registry) this.disposeRegisteredKernels(e), this.registry[
						e]
	...
	function ga() {
		return "undefined" != typeof window && null != window.document || "undefined" !=
	...
	function ya(e, t) {
		...
		for (var a = []; Array.isArray(n) || Rr(n) && "string" !== t;) a.push(n.length), n = n[0];
		return Array.isArray(e) && Z().getBool("TENSORLIKE_CHECK_SHAPE_CONSISTENCY") && ba(e, a, []), a
	}
	...
	function ba(e, t, n) {
		if (n = n || [], Array.isArray(e) || Rr(e)) {
			...
			for (var r = t.slice(1), a = 0; a < e.length; ++a) ba(e[a], r, n.concat(a))
		} else g(0 === t.length, (function() {
	...
	function wa(e, t, n, r) {
		if ("string_or_numeric" !== e) {
			...
			if ("numeric" !== e && e !== t || "numeric" === e && "string" === t) throw new Error(
				"Argument '"
				.concat(n, "' passed to '").concat(r, "' must ") + "be ".concat(e,
					" tensor, but got ")
				.concat(t, " tensor"))
		}
	}
	...
	function ka(e, t, n, r) {
		if (void 0 === r && (r = "numeric"), e instanceof Hr()) return wa(r, e.dtype, t, n), e;
		var a = F(e);
		if ("string" !== a && ["bool", "int32", "float32"].indexOf(r) >= 0 && (a = r), wa(r, a, t, n),
			null ==
			e || !Rr(e) && !Array.isArray(e) && "number" != typeof e && "boolean" != typeof e && "string" !=
			typeof e) {
	...
	ma.registerFlag("DEBUG", (function() {
		return !1
	}), (function(e) {
		e && console.warn(
		...
		return "undefined" != typeof process && "undefined" != typeof process.versions &&
			"undefined" != typeof process.versions.node
	})), ma.registerFlag("IS_CHROME", (function() {
		return "undefined" != typeof navigator && null != navigator && null != navigator
			.userAgent && /Chrome/.test(navigator.userAgent) && /Google Inc/.test(navigator
				.vendor)
	})), ma.registerFlag("IS_SAFARI", (function() {
		return "undefined" != typeof navigator && null != navigator && null != navigator
			.userAgent && /Safari/.test(navigator.userAgent) && /Apple/.test(navigator.vendor)
	...
	function Sa(e) {
		...
		var a = function() {
			...
			try {
				...
				return q(a) && console.error("Cannot return a Promise inside of tidy."), da.endScope(a),
					a
			} catch (e) {
	...
	var Aa = Sa({
		complex_: function(e, t) {
			var n = ka(e, "real", "complex"),
				r = ka(t, "imag", "complex");
			v(n.shape, r.shape, "real and imag shapes, ".concat(n.shape, " and ").concat(r
				.shape,
	...
	function _a(e, t, n, r) {
		...
		if (!Rr(e) && !Array.isArray(e) && "number" != typeof e && "boolean" != typeof e && "string" !=
		...
		if (null != t) {
			...
			var a = y(t),
				o = y(n);
			g(a === o, (function() {
				return "Based on the provided shape, [".concat(t,
		...
		return Rr(e) || Array.isArray(e) || (e = [e]), t = t || n, e = "string" !== r ? Nr(e, r) : Br(e, [],
			!
			0), da.makeTensor(e, t, r)
	}
	...
	var Na = {
		...
		Ma = function() {
			function e(e) {
				if (this.shards = [], this.previousShardIndex = 0, null != e && (e instanceof Array || (
						e = [
							e
						]), 0 !== (e = e.map((function(e) {
						return Rr(e) ? e.buffer : e
					}))).length)) {
					this.bufferUniformSize = e[0].byteLength;
					for (var t = 0, n = 0; n < e.length; n++) {
						var r = e[n];
						n !== e.length - 1 && r.byteLength !== this.bufferUniformSize && (this
							.bufferUniformSize = void 0);
					...
					0 === this.shards.length && (this.byteLength = 0), this.byteLength = this.shards[this
						.shards
						.length - 1].end
				}
			}
			return e.join = function(t) {
				return new e(t).slice()
			}, e.prototype.slice = function(e, t) {
				if (void 0 === e && (e = 0), void 0 === t && (t = this.byteLength), 0 === this.shards
					.length) return new ArrayBuffer(0);
				if (e = isNaN(Number(e)) ? 0 : e, t = isNaN(Number(t)) ? 0 : t, e = Math.max(0, e), (t =
						Math.min(this.byteLength, t)) <= e) return new ArrayBuffer(0);
				var n = this.findShardForByte(e);
				if (-1 === n) throw new Error("Could not find start shard for byte ".concat(e));
				for (var r = new ArrayBuffer(t - e), a = new Uint8Array(r), o = 0, i = n; i < this
					.shards
					.length; i++) {
					var s = this.shards[i],
						u = e + o - s.start,
				...
				if (null != this.bufferUniformSize) return this.previousShardIndex = Math.floor(e / this
					.bufferUniformSize), this.previousShardIndex;
	...
	function Pa(e, t) {
		...
		if ("quantization" in e) {
			...
			if ("string" === e.dtype) {
				for (var o = 0, i = 0; i < r; i++) o += 4 + new Uint32Array(t(o, o + 4))[0];
				return o
			}
			n = Na[e.dtype]
		}
	...
	function Oa(e, t) {
		return a(this, void 0, void 0, (function() {
			...
			return o(this, (function(o) {
				switch (o.label) {
					case 0:
						return n = y(e.shape), "quantization" in e ? (a = e
							.quantization, r = Na[a.dtype], [3, 7]) : [3, 1];
					case 1:
						if ("string" !== e.dtype) return [3, 6];
						i = 0, s = 0, o.label = 2;
					case 2:
						return s < n ? (u = i, c = 4, l = Uint32Array.bind, [4, t(i,
							i +
							4)]) : [3, 5];
					case 3:
						i = u + (c + (new(l.apply(Uint32Array, [void 0, o
						.sent()])))[
								0]), o.label = 4;
					case 4:
						return s++, [3, 2];
	...
	function La(e, t) {
		...
		if ("quantization" in e) {
			...
			if ("uint8" === h.dtype || "uint16" === h.dtype) {
				if (!("min" in h) || !("scale" in h)) throw new Error("Weight ".concat(e.name,
						" with quantization ").concat(h.dtype, " ") +
					"doesn't have corresponding metadata min and scale.")
			} else {
				if ("float16" !== h.dtype) throw new Error("Weight ".concat(e.name, " has unknown ") +
					"quantization dtype ".concat(h.dtype, ". ") +
					"Supported quantization dtypes are: 'uint8', 'uint16', and 'float16'.");
				if ("float32" !== s) throw new Error("Weight ".concat(e.name, " is quantized with ").concat(
					h
					.dtype, " ") + "which only supports weights of type float32 not ".concat(s,
					"."))
			}
			var f = Na[h.dtype],
			...
			if ("float32" === s)
				if ("uint8" === h.dtype || "uint16" === h.dtype) {
					...
					if ("float16" !== h.dtype) throw new Error("Unsupported quantization type ".concat(h
						.dtype,
						" ") + "for weight type float32.");
					var v = (r = function() {
						var e = function(e) {
								for (var t = e << 13, n = 0; 0 == (8388608 & t);) n -= 8388608,
									t <<= 1;
						...
						for (var t = new ArrayBuffer(4 * e.length), n = new Uint32Array(t), i =
							0; i < e
							.length; i++) {
							var s = e[i],
				...
				if ("int32" !== s) throw new Error("Unsupported dtype in weight '".concat(i, "': ").concat(
					s));
				if ("uint8" !== h.dtype && "uint16" !== h.dtype) throw new Error(
					"Unsupported quantization type ".concat(h.dtype, " ") + "for weight type int32."
					);
			...
			if ("float32" === s) n = new Float32Array(t);
				...
				if ("bool" !== s) {
					if ("complex64" === s) {
						...
						for (p = 0; p < x.length; p++) x[p] = n[2 * p], E[p] = n[2 * p + 1];
						var S = Ia(x, u, "float32"),
							A = Ia(E, u, "float32"),
							_ = Aa(S, A);
						return S.dispose(), A.dispose(), _
					}
					throw new Error("Unsupported dtype in weight '".concat(i, "': ").concat(s))
				}
				n = new Uint8Array(t)
			}
			l += c * k
				...
				switch (o.label) {
					...
					case 2:
						if (a = o.sent(), i = a.done, s = a.value, i && null == s)
							throw u = n - r.byteLength, new Error(
								"Reader is done but "
								.concat(u, " bytes are still expected"));
						return (c = new Uint8Array(r.length + s.byteLength)).set(r,
								0),
							c.set(new Uint8Array(s), r.length), r = c, [3, 1];
					case 3:
						return [2, r.buffer]
				}
			}))
	...
	function Ua(e) {
		...
		e.forEach((function(e) {
			if (t += e.byteLength, n.push(e.byteLength === e.buffer.byteLength ? e : new e
					.constructor(e)), !(e instanceof Float32Array || e instanceof Int32Array ||
					e instanceof Uint8Array)) throw new Error("Unsupported TypedArray subtype: "
	...
	var Wa = "undefined" != typeof Buffer && ("undefined" == typeof Blob || "undefined" == typeof atob ||
	...
	function Ka(e, t) {
		...
		return null != e.signature && (n.signature = e.signature), null != e.userDefinedMetadata && (n
			.userDefinedMetadata = e.userDefinedMetadata), null != e.modelInitializer && (n
			.modelInitializer = e.modelInitializer), null != e.initializerSignature && (n
			.initializerSignature = e.initializerSignature), null != e.trainingConfig && (n
			.trainingConfig =
			e.trainingConfig), n
	}
	...
	function Va(e, t, n) {
		...
		return null != e.signature && (r.signature = e.signature), null != e.userDefinedMetadata && (r
			.userDefinedMetadata = e.userDefinedMetadata), null != e.modelInitializer && (r
			.modelInitializer = e.modelInitializer), null != e.initializerSignature && (r
			.initializerSignature = e.initializerSignature), r
	}
	...
	function Ha(e, t) {
		return a(this, void 0, void 0, (function() {
			...
			return o(this, (function(o) {
				switch (o.label) {
					case 0:
						return null == e.weightsManifest ? [3, 2] : [4, t(e
							.weightsManifest)];
					case 1:
						a = s.apply(void 0, [o.sent(), 2]), n = a[0], r = a[1], o
							.label = 2;
					case 2:
						return [2, Va(e, n, r)]
				}
	...
	function ja(e) {
		if (e.modelTopology instanceof ArrayBuffer) throw new Error(
			"Expected JSON model topology, received ArrayBuffer.");
		return {
			dateSaved: new Date,
			modelTopologyType: "JSON",
			modelTopologyBytes: null == e.modelTopology ? 0 : Ga(JSON.stringify(e.modelTopology)),
			weightSpecsBytes: null == e.weightSpecs ? 0 : Ga(JSON.stringify(e.weightSpecs)),
			weightDataBytes: null == e.weightData ? 0 : new Ma(e.weightData).byteLength
		}
	}
	...
	var Za = function() {
			...
			return e.getInstance = function() {
				...
				var a = [];
				return ("load" === n ? e.getInstance().loadRouters : e.getInstance().saveRouters)
					.forEach((
						function(e) {
							var n = e(t, r);
							null !== n && a.push(n)
	...
	function $a() {
		if (!Z().getBool("IS_BROWSER")) throw new Error(
	...
	function eo(e) {
		var t = e.result;
		t.createObjectStore(Xa, {
			keyPath: "modelPath"
		}), t.createObjectStore(Qa, {
			keyPath: "modelPath"
		})
	}
	var to = function() {
		function e(e) {
			if (this.indexedDB = $a(), null == e || !e) throw new Error(
				...
				a.onupgradeneeded = function() {
					...
					if (null == t) {
						...
						s.onsuccess = function() {
							if (null == s.result) return o.close(), r(new Error(
						...
						u.onsuccess = function() {
							var a, i = (c = o.transaction(Xa, "readwrite"))
								.objectStore(Xa);
							try {
								a = i.put({
									modelPath: n.modelPath,
							...
							a.onsuccess = function() {
								...
								var t = (f = h.objectStore(Qa)).delete(n
									.modelPath);
							...
							null == c ? o.close() : c.oncomplete = function() {
								return o.close()
							}
						}
					}
	...
	var no = function(e) {
		return Z().getBool("IS_BROWSER") && !Array.isArray(e) && e.startsWith(to.URL_SCHEME) ? (t = e
			.slice(
				to.URL_SCHEME.length), new to(t)) : null;
		var t
	};
	...
	var ro = function() {
			...
			return e.prototype.listModels = function() {
				...
				return a(this, void 0, void 0, (function() {
					...
					return o(this, (function(n) {
						var r;
						return e = (r = e).startsWith(to.URL_SCHEME) ? r.slice(
							to
							.URL_SCHEME.length) : r, [2, new Promise((
							function(
								n, r) {
	...
	var go = function() {
		function e(e) {
			if (!Z().getBool("IS_BROWSER") || "undefined" == typeof window || "undefined" ==
				typeof window
				.localStorage) throw new Error(
				"The current environment does not support local storage.");
			if (this.LS = window.localStorage, null == e || !e) throw new Error(
		...
		return e.prototype.save = function(e) {
			return a(this, void 0, void 0, (function() {
				...
				return o(this, (function(o) {
					...
					t = JSON.stringify(e.modelTopology), n = JSON.stringify(
						e
						.weightSpecs), r = ja(e), a = Ma.join(e
						.weightData);
					try {
						return this.LS.setItem(this.keys.info, JSON
								.stringify(
									r)), this.LS.setItem(this.keys.topology,
								t),
							this.LS.setItem(this.keys.weightSpecs, n), this
							.LS
							.setItem(this.keys.weightData, function(e) {
								if (Wa) return Buffer.from(e).toString(
									"base64");
								for (var t = new Uint8Array(e), n = "",
										r =
										0, a = t.length; r < a; r++)
									n +=
								...
								generatedBy: e.generatedBy,
								convertedBy: e.convertedBy,
								signature: null != e.signature ? e
									.signature : void 0,
								userDefinedMetadata: null != e
									.userDefinedMetadata ? e
									.userDefinedMetadata : void 0,
								modelInitializer: null != e
									.modelInitializer ? e
									.modelInitializer : void 0,
								initializerSignature: null != e
									.initializerSignature ? e
									.initializerSignature : void 0,
								trainingConfig: null != e.trainingConfig ? e
									.trainingConfig : void 0
							}, this.LS.setItem(this.keys.modelMetadata, JSON
								.stringify(i)), [2, {
								modelArtifactsInfo: r
							}]
					} catch (e) {
						throw fo(this.keys), new Error(
							"Failed to save model '"
							.concat(this.modelPath,
								"' to local storage: ") +
							"size quota being exceeded is a possible cause of this failure: " +
							"modelTopologyBytes=".concat(r
								.modelTopologyBytes, ", ") +
							"weightSpecsBytes=".concat(r
								.weightSpecsBytes,
								", ") + "weightDataBytes=".concat(r
								.weightDataBytes, "."))
					}
					return [2]
				}))
			...
			return a(this, void 0, void 0, (function() {
				var e, t, n, r, a, i, s;
				return o(this, (function(o) {
					if (null == (e = JSON.parse(this.LS.getItem(this.keys
							.info)))) throw new Error(
						"In local storage, there is no model with name '"
						.concat(this.modelPath, "'"));
					if ("JSON" !== e.modelTopologyType) throw new Error(
						"BrowserLocalStorage does not support loading non-JSON model topology yet."
					);
					if (t = {}, null == (n = JSON.parse(this.LS.getItem(this
							.keys.topology)))) throw new Error(
						"In local storage, the topology of model '"
						.concat(this.modelPath, "' ") +
						"is missing.");
					if (t.modelTopology = n, null == (r = JSON.parse(this.LS
							.getItem(this.keys.weightSpecs))))
					throw new Error(
							"In local storage, the weight specs of model '"
							.concat(this.modelPath, "' ") +
							"are missing.");
					if (t.weightSpecs = r, null != (a = this.LS.getItem(this
							.keys.modelMetadata)) && (i = JSON.parse(a), t
							.format = i.format, t.generatedBy = i
							.generatedBy, t
							.convertedBy = i.convertedBy, null != i
							.signature &&
							(t.signature = i.signature), null != i
							.userDefinedMetadata && (t.userDefinedMetadata =
								i
								.userDefinedMetadata), null != i
							.modelInitializer && (t.modelInitializer = i
								.modelInitializer), null != i
							.initializerSignature && (t
								.initializerSignature = i
								.initializerSignature), null != i
							.trainingConfig && (t.trainingConfig = i
								.trainingConfig)), null == (s = this.LS
							.getItem(
								this.keys.weightData))) throw new Error(
					...
					return t.weightData = function(e) {
						if (Wa) {
							...
							return t.buffer.slice(t.byteOffset, t
								.byteOffset + t.byteLength)
						}
						for (var n = atob(e), r = new Uint8Array(n
									.length),
								a = 0; a < n.length; ++a) r.set([n
							.charCodeAt(a)
						], a);
						return r.buffer
					}(s), [2, t]
	...
	var vo = function(e) {
		return Z().getBool("IS_BROWSER") && !Array.isArray(e) && e.startsWith(go.URL_SCHEME) ? (t = e
			.slice(
				go.URL_SCHEME.length), new go(t)) : null;
		var t
	};
	...
	var mo = function() {
			function e() {
				...
				})), g("undefined" == typeof window || "undefined" != typeof window.localStorage, (
					function() {
			...
			return e.prototype.listModels = function() {
				return a(this, void 0, void 0, (function() {
					var e, t, n, r, a, i;
					return o(this, (function(o) {
						for (e = {}, t = oo + ao, n = ao + io, r = 0; r < this
							.LS
							.length; ++r)(a = this.LS.key(r)).startsWith(t) && a
							.endsWith(n) && (i = po(a), e[i] = JSON.parse(this
								.LS
								.getItem(a)));
						return [2, e]
					}))
				...
				return a(this, void 0, void 0, (function() {
					...
					return o(this, (function(r) {
						var a;
						if (e = (a = e).startsWith(go.URL_SCHEME) ? a.slice(go
								.URL_SCHEME.length) : a, t = ho(e), null == this
							.LS
							.getItem(t.info)) throw new Error(
							"Cannot find model at path '".concat(e, "'")
							);
						return n = JSON.parse(this.LS.getItem(t.info)), fo(t), [
							2,
							n
						]
					}))
		...
		bo = function() {
			...
			return e.getInstance = function() {
				...
				})), t.endsWith(yo) && (t = t.slice(0, t.indexOf(yo))), g(t.length > 0, (
			function() {
	...
	function wo(e) {
		if (-1 === e.indexOf(yo)) throw new Error(
				...
				switch (o.label) {
					case 0:
						return g(e !== t, (function() {
								return "Old path and new path are the same: '"
									.concat(e, "'")
							})), g((r = Za.getLoadHandlers(e)).length > 0, (
								function() {
								...
								return "Copying failed because more than one ("
									.concat(r.length, ") ") +
									"load handlers for source URL ".concat(
										e,
										".")
							})), a = r[0], g((i = Za.getSaveHandlers(t)).length > 0,
								(
									function() {
								...
								return "Copying failed because more than one ("
									...
									.concat(
										t, ".")
							})), s = i[0], u = wo(e).scheme, c = wo(e).path, l =
							u ===
							wo(e).scheme, [4, a.load()];
					case 1:
						return h = o.sent(), n && l ? [4, bo.getManager(u)
							.removeModel(
								c)
						] : [3, 3];
					case 2:
					...
					case 3:
						return [4, s.save(h)];
					case 4:
						return f = o.sent(), !n || l ? [3, 6] : [4, bo.getManager(u)
							.removeModel(c)
						];
					case 5:
						o.sent(), o.label = 6;
	...
	var xo = function() {
		...
		return e.prototype.fetch = function(e, t) {
			...
			if ("utf-8" !== t && "utf8" !== t) throw new Error(
				"Browser's encoder only supports utf-8, but got ".concat(t));
			return null == this.textEncoder && (this.textEncoder = new TextEncoder), this
				.textEncoder
				.encode(e)
			...
			var n = this;
			"undefined" != typeof window && Z().getBool("USE_SETTIMEOUTCUSTOM") ? (this.functionRefs
				.push(e), setTimeout((function() {
					window.postMessage({
						name: n.messageName,
						index: n.functionRefs.length - 1
					}, "*")
				}), t), this.hasEventListener || (this.hasEventListener = !0, window
					.addEventListener("message", (function(e) {
						e.source === window && e.data.name === n.messageName && (e
							.stopPropagation(), (0, n.functionRefs[e.data.index])(),
							n
							.handledMessageCount++, n.handledMessageCount === n
							.functionRefs.length && (n.functionRefs = [], n
	...
	var Eo, So = function() {
		...
		Ao = function() {
			...
			return e.prototype.fetch = function(e, t) {
				return null != Z().global.fetch ? Z().global.fetch(e, t) : (null == Eo && (Eo = So()),
					Eo(e,
						t))
			}, e.prototype.now = function() {
				...
				return this.util.types.isFloat32Array(e) || this.util.types.isInt32Array(e) || this.util
					.types.isUint8Array(e) || this.util.types.isUint8ClampedArray(e)
			}, e
		}();

	function _o(e, t, n) {
		return void 0 === t && (t = "float32"), t = t || "float32", G(e), new Gr(e, t, n)
	}
	Z().get("IS_NODE") && !Z().get("IS_BROWSER") && Z().setPlatform("node", new Ao);
	var Io = Sa({
		cast_: function(e, t) {
			var n = ka(e, "x", "cast");
			if (!N(t)) throw new Error("Failed to cast to unknown dtype ".concat(t));
			if ("string" === t && "string" !== n.dtype || "string" !== t && "string" === n
				.dtype)
	...
	var No = Sa({
		clone_: function(e) {
			var t = {
				x: ka(e, "x", "clone", "string_or_numeric")
			};
	...
	var Ro = Sa({
		div_: function(e, t) {
			var n, r = ka(e, "a", "div"),
				a = ka(t, "b", "div");
			if (r = (n = s(ra(r, a), 2))[0], a = n[1], "int32" === r.dtype && "int32" === a
				.dtype)
				return Do(r, a);
			var o = {
				a: r,
	...
	var Oo = Sa({
		addN_: function(e) {
			...
			t.forEach((function(e) {
				...
				if (!w(e.shape, n.shape)) throw new Error(
	...
	function Jo(e, t, n, r, a, o, i, u) {
		...
		var h = s([-1, -1, -1, -1], 4),
			...
			p = h[2],
			g = h[3];
		if ("channelsLast" === u) f = (c = s(e, 4))[0], d = c[1], p = c[2], g = c[3];
		else {
			if ("channelsFirst" !== u) throw new Error("Unknown dataFormat ".concat(u));
		...
		var v, m = s(t, 4),
			...
			M = function(e, t, n, r, a, o, i, s, u) {
				...
				if ("number" == typeof e) {
					...
					right: 0,
					type: "VALID"
				}, l = Math.ceil((t - o + 1) / r), h = Math.ceil((n - i + 1) / a);
				else {
					...
					c = {
						...
						type: 0 === g && 0 === v && 0 === m && 0 === y ? "VALID" : "EXPLICIT"
					}, l = ei((t - o + g + v) / r + 1, s), h = ei((n - i + m + y) / a + 1, s)
				}
				return {
					padInfo: c,
					outHeight: l,
			...
			R = M.outWidth,
			B = i ? w * g : w;
		return "channelsFirst" === u ? v = [f, B, D, R] : "channelsLast" === u && (v = [f, D, R, B]), {
			batchSize: f,
			dataFormat: u,
			inHeight: d,
			inWidth: p,
	...
	function Zo(e, t, n, r, a, o, i, u) {
		...
		var h = s([-1, -1, -1, -1, -1], 5),
			...
			g = h[3],
			v = h[4];
		if ("channelsLast" === i) f = (c = s(e, 5))[0], d = c[1], p = c[2], g = c[3], v = c[4];
		else {
			if ("channelsFirst" !== i) throw new Error("Unknown dataFormat ".concat(i));
		...
		var m, y = s(t, 5),
			...
			F = function(e, t, n, r, a, o, i, s, u, c, l) {
				...
				if ("number" == typeof e) {
					...
					var g = function(e, t, n, r, a, o) {
						...
						for (var i = [0, 0, 0, n], s = 0; s < 3; s++) e[s] + 2 * a >= t[s] && (i[s] =
							ei((e[
								s] - t[s] + 2 * a) / r[s] + 1, o));
						return i
			...
			L = F.outWidth,
			z = o ? x * v : x;
		return "channelsFirst" === i ? m = [f, z, P, O, L] : "channelsLast" === i && (m = [f, P, O, L,
		z]), {
			batchSize: f,
			dataFormat: i,
			inDepth: d,
	...
	function oi(e, t, n) {
		if (null != n) {
			if ("string" == typeof t) throw Error("Error in ".concat(e,
					...
					" but got pad ")
				.concat(t, "."));
			if ("number" == typeof t) g(k(t), (function() {
	...
	var ii = Sa({
		reshape_: function(e, t) {
			var n = {
					x: ka(e, "x", "reshape", "string_or_numeric")
				},
				r = {
					shape: t
				};
	...
	var si = Sa({
		avgPool_: function(e, t, n, r, a) {
			...
			var i = o,
				s = !1;
			3 === o.rank && (s = !0, i = ii(o, [1, o.shape[0], o.shape[1], o.shape[2]])), g(
				4 === i
				.rank, (function() {
					return "Error in avgPool: x must be rank 4 but got rank ".concat(i
						.rank,
						".")
				})), oi("avgPool", r, a);
			var u = {
			...
			return l = Io(l, o.dtype), s ? ii(l, [l.shape[1], l.shape[2], l.shape[3]]) : l
		}
	});
	var ui = Sa({
		avgPool3d_: function(e, t, n, r, a, o) {
			...
			var i = ka(e, "x", "avgPool3d", "float32"),
				s = i,
				u = !1;
			4 === i.rank && (u = !0, s = ii(i, [1, i.shape[0], i.shape[1], i.shape[2], i.shape[
				3]])), g(5 === s.rank, (function() {
				return "Error in avgPool3d: x must be rank 5 but got rank ".concat(s
					.rank, ".")
			})), g("NDHWC" === o, (function() {
				return "Error in avgPool3d: Only NDHWC is currently supported, " +
					"but got dataFormat of ".concat(o)
			})), g("number" == typeof n && n > 0 || Array.isArray(n) && n[0] > 0 && n[1] >
				0 &&
				n[2] > 0, (function() {
			...
			return h = Io(h, s.dtype), u ? ii(h, [h.shape[1], h.shape[2], h.shape[3], h.shape[
					4]]) :
				h
		}
	});
	var ci = Sa({
		concat_: function(e, t) {
			void 0 === t && (t = 0), g(e.length >= 1, (function() {
	...
	var vi = Sa({
		batchNorm_: function(e, t, n, r, a, o) {
			null == o && (o = .001);
			var i, s, u = ka(e, "x", "batchNorm"),
				c = ka(t, "mean", "batchNorm"),
				l = ka(n, "variance", "batchNorm");
			null != a && (i = ka(a, "scale", "batchNorm")), null != r && (s = ka(r, "offset",
				"batchNorm")), g(c.rank === l.rank, (function() {
			...
			var h = function(e) {
					return 0 === e.rank || 1 === e.rank ? ii(e, [1, 1, 1, e.size]) : 2 === e
						.rank ?
						ii(e, [1, 1, e.shape[0], e.shape[1]]) : 3 === e.rank ? ii(e, [1, e
							.shape[0],
							e.shape[1], e.shape[2]
						]) : e
				}(u),
	...
	var mi = Sa({
		batchNorm2d_: function(e, t, n, r, a, o) {
			var i, s, u = ka(e, "x", "batchNorm"),
				c = ka(t, "mean", "batchNorm"),
				l = ka(n, "variance", "batchNorm");
			return null != a && (i = ka(a, "scale", "batchNorm")), null != r && (s = ka(r,
				"offset",
				"batchNorm")), g(2 === u.rank, (function() {
			...
			})), null != s && g(2 === s.rank || 1 === s.rank, (function() {
		...
		batchNorm3d_: function(e, t, n, r, a, o) {
			...
			return null != a && (i = ka(a, "scale", "batchNorm")), null != r && (s = ka(r,
				...
				return "Error in batchNorm3D: scale must be rank 3 or rank 1 " +
					"but got rank ".concat(i.rank, ".")
			})), null != s && g(3 === s.rank || 1 === s.rank, (function() {
		...
		batchNorm4d_: function(e, t, n, r, a, o) {
			...
			return null != a && (i = ka(a, "scale", "batchNorm")), null != r && (s = ka(r,
				...
				return "Error in batchNorm4D: scale must be rank 4 or rank 1 " +
					"but got rank ".concat(i.rank, ".")
			})), null != s && g(4 === s.rank || 1 === s.rank, (function() {
	...
	var ki = Sa({
		bitwiseAnd_: function(e, t) {
			var n = ka(e, "x", "bitwiseAnd"),
				r = ka(t, "y", "bitwiseAnd");
			if (!w(n.shape, r.shape)) throw new Error(
				"BitwiseAnd: Tensors must have the same shape. x: ".concat(n.shape,
					", y: ")
				.concat(r.shape));
	...
	var Ei = Sa({
		broadcastTo_: function(e, t) {
			var n = ka(e, "broadcastTo", "x"),
				r = n.shape;
			if (G(t), t.length < n.rank) throw new Error("broadcastTo(): shape.length=".concat(t
			...
			for (var o = n.shape, i = Array.from(t), s = t.length - 1; s >= 0; s--)
				if (o[s] === t[s]) i[s] = 1;
				else if (1 !== n.shape[s]) throw new Error("broadcastTo(): [".concat(r,
	...
	var _i = Sa({
		clipByValue_: function(e, t, n) {
			...
			if (g(t <= n, (function() {
				...
				})), t === n) return Ai(r.shape, t, r.dtype);
			var a = {
					x: r
				},
				o = {
	...
	var Di = Sa({
		conv2d_: function(e, t, n, r, a, o, i) {
			...
			var s = ka(e, "x", "conv2d", "float32"),
				...
				c = s,
				l = !1;
			3 === s.rank && (l = !0, c = ii(s, [1, s.shape[0], s.shape[1], s.shape[2]])), g(
				4 === c
				.rank, (function() {
					return "Error in conv2d: input must be rank 4, but got rank "
						.concat(c
							.rank, ".")
				})), g(4 === u.rank, (function() {
			...
			g(h === u.shape[2], (function() {
				return "Error in conv2d: depth of input (".concat(h,
						") must match ") +
	...
	var Ri = Sa({
		conv1d_: function(e, t, n, r, a, o, i) {
			...
			var s = ka(e, "x", "conv1d"),
				...
				c = s,
				l = !1;
			2 === s.rank && (l = !0, c = ii(s, [1, s.shape[0], s.shape[1]])), g(3 === c.rank, (
				function() {
					return "Error in conv1d: input must be rank 3, but got rank "
						.concat(c
							.rank, ".")
				})), g(3 === u.rank, (function() {
				return "Error in conv1d: filter must be rank 3, but got rank " + ""
					.concat(u.rank, ".")
			})), oi("conv1d", r, i), g(c.shape[2] === u.shape[1], (function() {
				return "Error in conv1d: depth of input (".concat(c.shape[2],
					") must match ") + "input depth for filter ".concat(u.shape[
						1],
					".")
			})), g(ni(n, o), (function() {
			...
			return ii(d, l ? [d.shape[2], d.shape[3]] : [d.shape[0], d.shape[2], d.shape[3]])
		}
	});
	var Bi = Sa({
		conv2DBackpropInput_: function(e, t, n, r, a, o, i) {
			void 0 === o && (o = "NHWC"), g(e.length === t.rank, (function() {
				return "Length of inShape " + "(".concat(e.length,
						") and rank of dy (")
			...
			var s = e,
				u = t,
				c = !1;
			3 === t.rank && (c = !0, u = ii(t, [1, t.shape[0], t.shape[1], t.shape[2]]), s = [1,
				e[
					0], e[1], e[2]
			...
			g(l === n.shape[2], (function() {
				return "Error in conv2dDerInput: depth of input (".concat(l,
					") must ") + "match input depth for filter ".concat(n.shape[
					2], ".")
			})), g(h === n.shape[3], (function() {
				return "Error in conv2dDerInput: depth of output (".concat(h,
					") must ") + "match output depth for filter ".concat(n
					.shape[3],
					".")
	...
	var Ci = Sa({
		conv3d_: function(e, t, n, r, a, o) {
			...
			var i = ka(e, "x", "conv3d"),
				...
				u = i,
				c = !1;
			4 === i.rank && (c = !0, u = ii(i, [1, i.shape[0], i.shape[1], i.shape[2], i.shape[
				3]])), g(5 === u.rank, (function() {
				return "Error in conv3d: input must be rank 5, but got rank "
					.concat(u
						.rank, ".")
			})), g(5 === s.rank, (function() {
				...
				return "Error in conv3d: depth of input (".concat(u.shape[4],
					") must match ") + "input depth for filter ".concat(s.shape[
						3],
					".")
			})), g(ni(n, o), (function() {
	...
	var Pi = Sa({
		conv3DBackpropInput_: function(e, t, n, r, a) {
			...
			var o = e,
				i = t,
				s = !1;
			4 === t.rank && (s = !0, i = ii(t, [1, t.shape[0], t.shape[1], t.shape[2], t.shape[
					3]]),
				o = [1, e[0], e[1], e[2], e[3]]);
			var u = o[4],
				c = i.shape[4];
		...
		denseBincount_: function(e, t, n, r) {
			...
			g("int32" === a.dtype, (function() {
				...
				return "Error in denseBincount: weights must have the same shape as x or " +
					"0-length, but got x shape: ".concat(a.shape,
						", weights shape: ") +
					"".concat(o.shape, ".")
			}));
			var i = {
	...
	var qi = Sa({
		depthToSpace_: function(e, t, n) {
			...
			g(t > 1, (function() {
				return "blockSize should be > 1 for depthToSpace, but was: ".concat(
					t)
			})), g(a * t >= 0, (function() {
				...
				return "Dimension size must be evenly divisible by ".concat(t * t,
						" but is ").concat(i, " for depthToSpace with input shape ")
					.concat(r.shape)
			}));
			var s = {
					x: r
	...
	var Hi = Sa({
		dilation2d_: function(e, t, n, r, a, o) {
			...
			var u = i,
				c = !1;
			3 === i.rank && (u = ii(i, [1, i.shape[0], i.shape[1], i.shape[2]]), c = !0), g(u
				.shape[
					3] === s.shape[2], (function() {
					return "Error in dilation2d:  input and filter must have the same depth: "
						.concat(u.shape[3], " vs ").concat(s.shape[2])
				}));
			var l = {
					x: u,
					filter: s
	...
	function Zi(e, t) {
		for (var n = Math.max(e.length, t.length), r = new Array(n), a = 0; a < n; a++) {
			...
			if (null == i && (i = 1), 1 === o) r[n - a - 1] = i;
				...
				if (o !== i) {
					var s = "Operands could not be broadcast together with shapes " + "".concat(e, " and ")
						.concat(t, ".");
					throw Error(s)
				}
				r[n - a - 1] = o
	...
	var Xi = Sa({
		equal_: function(e, t) {
			var n, r = ka(e, "a", "equal", "string_or_numeric"),
	...
	var ts = Sa({
		dot_: function(e, t) {
			...
			if (1 === n.rank && 2 === r.rank) {
				i = ii(n, [1, -1]), s = ii(r, [r.shape[0], r.shape[1]]), u = li(i, s);
				return ii(u, [u.size])
			}
	...
	var as = Sa({
		ensureShape_: function(e, t) {
			...
			if (!b(n.shape, t)) throw new Error("EnsureShape: Shape of tensor ".concat(n.shape,
	...
	function ss(e, t, n) {
		for (var r = e.length + t.length, a = [], o = 0, i = 0, s = 0; s < r; s++) - 1 === n.indexOf(s) ? a
			.push(e[o++]) : a.push(t[i++]);
		return a
	}

	function us(e, t) {
		return ss(e, t.map((function(e) {
			return 1
		})), t)
	}
	var cs = Sa({
	...
	function fs(e, t) {
		if ((Rr(e) && "string" !== t || Array.isArray(e)) && "complex64" !== t) throw new Error(
			"Error creating a new Scalar: value must be a primitive (number|boolean|string)");
		if ("string" === t && Rr(e) && !(e instanceof Uint8Array)) throw new Error(
	...
	function vs(e, t, n) {
		...
		if (1 === e.rank || "number" == typeof n || Array.isArray(n) && 1 === n.length) {
			...
			if ("euclidean" === t || 2 === t) return ds(gs(hs(Fo(e), fs(2, "int32")), n));
	...
	var ms = Sa({
		norm_: function(e, t, n, r) {
			void 0 === t && (t = "euclidean"), void 0 === n && (n = null), void 0 === r && (
				r = !1);
	...
	var ys = Sa({
		euclideanNorm_: function(e, t, n) {
			return void 0 === t && (t = null), void 0 === n && (n = !1), ms(e, "euclidean", t,
				n)
		}
	});
	var bs = Sa({
	...
	var _s = Sa({
		greater_: function(e, t) {
			var n, r = ka(e, "a", "greater", "string_or_numeric"),
	...
	var Is = Sa({
		greaterEqual_: function(e, t) {
			var n, r = ka(e, "a", "greaterEqual", "string_or_numeric"),
	...
	var Bs = Sa({
		less_: function(e, t) {
			var n, r = ka(e, "a", "less", "string_or_numeric"),
	...
	var Fs = Sa({
		lessEqual_: function(e, t) {
			var n, r = ka(e, "a", "lessEqual", "string_or_numeric"),
	...
	var Cs = Sa({
		localResponseNormalization_: function(e, t, n, r, a) {
			void 0 === t && (t = 5), void 0 === n && (n = 1), void 0 === r && (r = 1),
				void 0 ===
				a && (a = .5);
			...
			var i = o,
				s = !1;
			3 === o.rank && (s = !0, i = ii(o, [1, o.shape[0], o.shape[1], o.shape[2]]));
			var u = {
					x: i
				},
				c = {
	...
	function Ls(e, t) {
		...
		})), g(null == t || Array.isArray(t) && t.every((function(e) {
		...
		var n = null != t;
		if (!n)
			for (var r in t = [], da.registeredVariables) t.push(da.registeredVariables[r]);
		...
		t = t.filter((function(e) {
			...
			return "variableGrads() expects at least one of the input variables to " +
				"be trainable, but none of the ".concat(o, " variables is ") + "trainable."
		}));
	...
	var Qs = Sa({
		searchSorted_: function(e, t, n) {
			...
			var r = ka(e, "sortedSequence", "searchSorted"),
				...
				s = ii(r, [-1, o]),
				u = ii(a, [-1, i]);
			if (s.rank < 2) throw new Error(
				"Sorted input argument must be at least 2-dimensional");
			if (s.shape[0] !== u.shape[0]) throw new Error(
				"Leading dimension of 'sortedSequence' and 'values' must match.");
			if (y(u.shape) >= Xs) throw new Error("values tensor size must less than ".concat(
				Xs));
			if (s.shape[1] >= Xs) throw new Error("trailing dim_size must less than ".concat(Xs,
				" for int32 output type, was ").concat(s.shape[1]));
			var c = {
					sortedSequence: s,
					values: u
				},
	...
	var $s = Sa({
		maxPool_: function(e, t, n, r, a) {
			...
			3 === o.rank && (s = !0, i = ii(o, [1, o.shape[0], o.shape[1], o.shape[2]])), g(
				4 === i
				.rank, (function() {
					return "Error in maxPool: input must be rank 4 but got rank "
						.concat(i
							.rank, ".")
				})), g(ni(n, 1), (function() {
	...
	var eu = Sa({
		maxPool3d_: function(e, t, n, r, a, o) {
			...
			4 === i.rank && (u = !0, s = ii(i, [1, i.shape[0], i.shape[1], i.shape[2], i.shape[
				3]])), g(5 === s.rank, (function() {
				return "Error in maxPool3d: x must be rank 5 but got rank ".concat(s
					.rank, ".")
			})), g("NDHWC" === o, (function() {
	...
	var nu = Sa({
		maximum_: function(e, t) {
			var n, r = ka(e, "a", "maximum"),
				a = ka(t, "b", "maximum");
			r = (n = s(ra(r, a), 2))[0], a = n[1], "bool" === r.dtype && (r = Io(r, "int32"),
				a =
				Io(a, "int32")), Zi(r.shape, a.shape);
			var o = {
				a: r,
				b: a
			};
	...
	var su = Sa({
		mirrorPad_: function(e, t, n) {
			...
			for (var a = "reflect" === n ? 1 : 0, o = function(e) {
					...
					})), g(t[e][0] >= 0 && t[e][0] <= r.shape[e] - a && t[e][1] >= 0 &&
						t[e]
						[1] <= r.shape[e] - a, (function() {
	...
	var lu = Sa({
		multiRNNCell_: function(e, t, n, r) {
			for (var a = ka(t, "data", "multiRNNCell"), o = xa(n, "c", "multiRNNCell"), i = xa(
					r,
					"h", "multiRNNCell"), s = a, u = [], c = 0; c < e.length; c++) {
				var l = e[c](s, o[c], i[c]);
	...
	var hu = Sa({
		multinomial_: function(e, t, n, r) {
			...
			if (o < 2) throw new Error(
				...
				.concat(
					o, "."));
			if (i > 2) throw new Error("Rank of probabilities must be 1 or 2, but is ".concat(
				i));
			n = n || Math.random();
			var s = {
					logits: 1 === i ? ii(a, [1, -1]) : a
				},
				u = {
					numSamples: t,
					seed: n,
	...
	var fu = Sa({
		notEqual_: function(e, t) {
			var n, r = ka(e, "a", "notEqual", "string_or_numeric"),
	...
	var du = Sa({
		oneHot_: function(e, t, n, r, a) {
			if (void 0 === n && (n = 1), void 0 === r && (r = 0), void 0 === a && (a = "int32"),
				t <
				2) throw new Error("Error in oneHot: depth must be >=2, but it is ".concat(t));
			var o = {
					indices: ka(e, "indices", "oneHot", "int32")
				},
				i = {
					dtype: a,
					depth: t,
	...
	var mu = Sa({
		pad1d_: function(e, t, n) {
			return void 0 === n && (n = 0), g(2 === t.length, (function() {
	...
	var yu = Sa({
		pad2d_: function(e, t, n) {
			return void 0 === n && (n = 0), g(2 === t.length && 2 === t[0].length && 2 === t[1]
				.length, (function() {
					return "Invalid number of paddings. Must be length of 2 each."
				})), vu(e, t, n)
		}
	...
	var bu = Sa({
		pad3d_: function(e, t, n) {
			return void 0 === n && (n = 0), g(3 === t.length && 2 === t[0].length && 2 === t[1]
	...
	var wu = Sa({
		pad4d_: function(e, t, n) {
			return void 0 === n && (n = 0), g(4 === t.length && 2 === t[0].length && 2 === t[1]
			...
			var o = ka(e, "shape", "raggedTensorToTensor", "int32"),
				...
				s = {
					...
					rowPartitionTensors: r.map((function(e, t) {
						return ka(e, "tensors".concat(t), "raggedTensorToTensor",
							"int32")
					}))
				},
				u = {
		...
		! function(e, t, n) {
			function r(e) {
				...
				n.next = function() {
					...
					}, n.c = 1, n.s0 = r(" "), n.s1 = r(" "), n.s2 = r(" "), n.s0 -= r(e), n.s0 < 0 && (n
						.s0 +=
						1), n.s1 -= r(e), n.s1 < 0 && (n.s1 += 1), n.s2 -= r(e), n.s2 < 0 && (n.s2 += 1),
					r =
					null
			}
			...
			function o(e, t) {
				...
				}, i.quick = i, o && ("object" == typeof o && a(o, n), i.state = function() {
					return a(n, {})
				}), i
			}
		...
		! function(e, t, n) {
			...
			function o(e, t) {
				...
				return i.double = function() {
					...
					return e
				}, i.int32 = n.next, i.quick = i, o && ("object" == typeof o && a(o, n), i.state =
					function() {
						return a(n, {})
					}), i
			}
	...
	! function(e) {
		! function(e, t, n) {
			function r(e) {
				...
				t.next = function() {
					var e = t.x ^ t.x >>> 2;
					return t.x = t.y, t.y = t.z, t.z = t.w, t.w = t.v, (t.d = t.d + 362437 | 0) + (t.v =
						t
						.v ^ t.v << 4 ^ e ^ e << 1) | 0
				}, t.x = 0, t.y = 0, t.z = 0, t.w = 0, t.v = 0, e === (0 | e) ? t.x = e : n += e;
				for (var r = 0; r < n.length + 64; r++) t.x ^= 0 | n.charCodeAt(r), r == n.length && (t.d =
					t
					.x << 10 ^ t.x >>> 4), t.next()
			}
		...
		! function(e, t, n) {
			function r(e) {
				...
				t.next = function() {
						var e, n, r = t.x,
							a = t.i;
						return e = r[a], n = (e ^= e >>> 7) ^ e << 24, n ^= (e = r[a + 1 & 7]) ^ e >>> 10,
							n ^=
							(e = r[a + 3 & 7]) ^ e >>> 3, n ^= (e = r[a + 4 & 7]) ^ e << 7, e = r[a + 7 &
							7],
					...
					function(e, t) {
						...
						if (t === (0 | t)) r[0] = t;
							...
							for (t = "" + t, n = 0; n < t.length; ++n) r[7 & n] = r[7 & n] << 15 ^ t
								.charCodeAt(
									n) + r[n + 1 & 7] << 13;
			...
			function o(e, t) {
				...
				return i.double = function() {
					...
					return e
				}, i.int32 = n.next, i.quick = i, o && (o.x && a(o, n), i.state = function() {
					return a(n, {})
				}), i
			}
			t && t.exports ? t.exports = o : n && n.amd ? n((function() {
			...
			function r(e) {
				...
				t.next = function() {
						var e, n, r = t.w,
							a = t.X,
							o = t.i;
						return t.w = r = r + 1640531527 | 0, n = a[o + 34 & 127], e = a[o = o + 1 & 127],
							n ^=
							n << 13, e ^= e << 17, n ^= n >>> 15, e ^= e >>> 12, n = a[o] = n ^ e, t.i = o,
							n +
							(r ^ r >>> 16) | 0
					},
					function(e, t) {
						var n, r, a, o, i, s = [],
							u = 128;
						for (t === (0 | t) ? (r = t, t = null) : (t += "\0", r = 0, u = Math.max(u, t
								.length)),
							a = 0, o = -32; o < u; ++o) t && (r ^= t.charCodeAt((o + 32) % t.length)), 0 ===
							o && (i = r), r ^= r << 10, r ^= r >>> 15, r ^= r << 4, r ^= r >>> 13, o >= 0 &&
							(
								i = i + 1640531527 | 0, a = 0 == (n = s[127 & o] ^= r + i) ? a + 1 : 0);
						for (a >= 128 && (s[127 & (t && t.length || 0)] = -1), a = 127, o = 512; o > 0; --o)
							r =
							s[a + 34 & 127], n = s[a = a + 1 & 127], r ^= r << 13, n ^= n << 17, r ^= r >>>
							15,
							n ^= n >>> 12, s[a] = r ^ n;
						e.w = i, e.X = s, e.i = a
					}(t, e)
			...
			function r(e) {
				...
				t.next = function() {
					var e = t.b,
						...
						r = t.d,
						a = t.a;
					return e = e << 25 ^ e >>> 7 ^ n, n = n - r | 0, r = r << 24 ^ r >>> 8 ^ a, a = a -
						e |
						0, t.b = e = e << 20 ^ e >>> 12 ^ n, t.c = n = n - r | 0, t.d = r << 16 ^ n >>>
						16 ^
						a, t.a = a - e | 0
				}, t.a = 0, t.b = 0, t.c = -1640531527, t.d = 1367130551, e === Math.floor(e) ? (t.a =
					e /
		...
		! function(t, n, r) {
			...
			function l(e, c, l) {
				var v = [],
					m = p(d((c = 1 == c ? {
						entropy: !0
					} : c || {}).entropy ? [e, g(n)] : null == e ? function() {
						try {
							var e;
							return a && (e = a.randomBytes) ? e = e(o) : (e = new Uint8Array(o), (t
								.crypto || t.msCrypto).getRandomValues(e)), g(e)
						} catch (e) {
							var r = t.navigator,
								i = r && r.plugins;
					...
					y = new h(v),
					b = function() {
						for (var e = y.g(6), t = i, n = 0; e < s;) e = (e + n) * o, t *= o, n = y.g(1);
						for (; e >= u;) e /= 2, t /= 2, n >>>= 1;
						return (e + n) / t
					};
				...
				}, b.double = b, p(g(y.S), n), (c.pass || l || function(e, t, n, a) {
			...
			function h(e) {
				var t, n = e.length,
					...
					s = r.S = [];
				for (n || (e = [n++]); a < o;) s[a] = a++;
				for (a = 0; a < o; a++) s[a] = s[i = c & i + e[a % n] + (t = s[a])], s[i] = t;
				(r.g = function(e) {
					for (var t, n = 0, a = r.i, i = r.j, s = r.S; e--;) t = s[a = c & a + 1], n = n *
						o + s[
							c & (s[a] = s[i = c & i + t]) + (s[i] = t)];
	...
	var Gu = Tu,
		...
		ju = Uu,
		Ju = Wu.exports;
	Ju.alea = Gu, Ju.xor128 = qu, Ju.xorwow = Ku, Ju.xorshift7 = Vu, Ju.xor4096 = Hu, Ju.tychei = ju;
	var Zu = Ju;

	function Yu() {
		return 32 === da.backend.floatPrecision() ? .001 : .1
	}
	...
	function Xu(e, t, n) {
		...
		if ((Rr(e) || Rr(t)) && (r = !1), Rr(e) && Rr(t) && (r = !0), r) {
			...
			if (a !== o) throw new Error("Arrays are of different type. Actual: ".concat(a, ". ") +
				"Expected: "
				.concat(o))
		}
		if (Array.isArray(e) && Array.isArray(t)) {
			var i = ya(e),
				s = ya(t);
			if (!w(i, s)) throw new Error("Arrays have different shapes. " + "Actual: [".concat(i,
				"]. Expected: [").concat(s, "]"))
		}
		var u = Rr(e) ? e : Br(e),
			c = Rr(t) ? t : Br(t);
		if (u.length !== c.length) throw new Error("Arrays have different lengths actual: ".concat(u.length,
				" vs ") + "expected: ".concat(c.length, ".\n") + "Actual:   ".concat(u, ".\n") +
			"Expected: ".concat(c, "."));
		for (var l = 0; l < c.length; ++l) {
			var h = u[l],
				f = c[l];
			if (!n(h, f)) throw new Error("Arrays differ: actual[".concat(l, "] = ").concat(h,
					", expected[")
				.concat(l, "] = ").concat(f, ".\n") + "Actual:   ".concat(u, ".\n") + "Expected: "
				.concat(c, "."))
		}
	...
	var $u = {
			...
			createVideoElement: function(e) {
				...
				return "playsInline" in t && (t.playsInline = !0), t.muted = !0, t.loop = !0, t.style
					.position = "fixed", t.style.left = "0px", t.style.top = "0px", t.preload = "auto",
					t
					.appendChild(e), new Promise((function(e) {
			...
			expectArrayBuffersEqual: function(e, t) {
				...
				if (n.length !== r.length) throw new Error("Expected ArrayBuffer to be of length " + ""
					.concat(r.length, ", but it was ").concat(n.length));
				for (var a = 0; a < r.length; a++)
					if (n[a] !== r[a]) throw new Error("Expected ArrayBuffer value at ".concat(a,
						" to be ") + "".concat(r[a], " but got ").concat(n[a], " instead"))
			},
			expectArraysClose: function(e, t, n) {
				return null == n && (n = Yu()), Xu(e, t, (function(e, t) {
					return Qu(e, t, n)
				}))
			},
			expectArraysEqual: function(e, t) {
				var n = "string" == typeof t || "number" == typeof t || "boolean" == typeof t ? [t] : t;
				return D(e) || D(e[0]) || D(t) || D(t[0]) ? Xu(e, n, (function(e, t) {
					return e == t
				})) : Xu(e, t, (function(e, t) {
					return Qu(e, t, 0)
				}))
			...
			expectNumbersClose: function(e, t, n) {
				if (null == n && (n = Yu()), !Qu(e, t, n)) throw new Error("Numbers differ: actual === "
					.concat(e, ", expected === ").concat(t));
				"undefined" != typeof expect && expect().nothing()
			},
			...
			expectValuesInRange: function(e, t, n) {
				for (var r = 0; r < e.length; r++)
					if (e[r] < t || e[r] > n) throw new Error("Value out of range:".concat(e[r],
							" low: ")
						.concat(t, ", high: ").concat(n))
			},
			play: function(e) {
				return a(this, void 0, void 0, (function() {
					return o(this, (function(t) {
						switch (t.label) {
							case 0:
								return [4, e.play()];
							case 1:
								return t.sent(), "requestVideoFrameCallback" in
									e ? [4, new Promise((function(t) {
		...
		ec = function() {
			function e(e, t, n, r, a) {
				this.mean = e, this.stdDev = t, this.dtype = n, this.nextVal = NaN, this.truncated = r, this
					.truncated && (this.upper = this.mean + 2 * this.stdDev, this.lower = this.mean - 2 *
						this
						.stdDev);
				var o = a || Math.random();
			...
			return e.prototype.nextValue = function() {
				...
				for (var t, n, r = !1; !r;) {
					...
					t = this.mean + this.stdDev * a * s, n = this.mean + this.stdDev * o * s, this
						.truncated && !this.isValidTruncated(t) || (r = !0)
				}
				return this.truncated && !this.isValidTruncated(n) || (this.nextVal = this.convertValue(
						n)),
					this.convertValue(t)
		...
		tc = function() {
			function e(e, t, n, r) {
				...
				var a = r || Math.random();
				this.randu = Zu.alea(a.toString()), this.randn = new ec(0, 1, n, !1, this.randu()), this.d =
					e <
			...
			return e.prototype.nextValue = function() {
				for (var e, t, n, r, a, o;;) {
					...
					if (o *= o * o, t = 1 - .331 * (e = r * r) * e, n = .5 * e + this.d * (1 - o + Math
							.log(
								o)), (a = this.randu()) < t || Math.log(a) < n) break
				}
				return o = 1 / this.beta * this.d * o, this.alpha < 1 && (o *= Math.pow(this.randu(),
					1 /
	...
	var rc = Sa({
		randomGamma_: function(e, t, n, r, a) {
			if (void 0 === n && (n = 1), void 0 === r && (r = "float32"), G(e), null == n && (
					n =
					1), null == r && (r = "float32"), "float32" !== r && "int32" !== r)
			throw new Error(
					"Unsupported data type ".concat(r));
			for (var o = new tc(t, n, r, a), i = _o(e, r), s = 0; s < i.values.length; s++) i
				.values[s] = o.nextValue();
			return i.toTensor()
		}
	});
	var ac = Sa({
		randomNormal_: function(e, t, n, r, a) {
			if (void 0 === t && (t = 0), void 0 === n && (n = 1), G(e), null != r && "bool" ===
				r)
				throw new Error("Unsupported data type ".concat(r));
			for (var o = new ec(t, n, r, !1, a), i = _o(e, r), s = 0; s < i.values.length; s++)
				i
				.values[s] = o.nextValue();
			return i.toTensor()
		}
	...
	var ic = Sa({
		randomUniform_: function(e, t, n, r, a) {
			void 0 === t && (t = 0), void 0 === n && (n = 1), void 0 === r && (r = "float32"),
				G(e);
			for (var o = _o(e, r), i = new nc(t, n, null, a), s = 0; s < o.values.length; s++) o
	...
	var kc = Sa({
		separableConv2d_: function(e, t, n, r, a, o, i) {
			...
			var s = ka(e, "x", "separableConv2d"),
				...
				l = s,
				h = !1;
			if (3 === s.rank && (h = !0, l = ii(s, [1, s.shape[0], s.shape[1], s.shape[2]])),
				"NCHW" === i) throw new Error(
			...
			g(c.shape[2] === f * d, (function() {
				return "Error in separableConv2d: the third dimension of pointwise filter " +
					"must be ".concat(f * d, ", ") + "but got ".concat(c.shape[2],
						".")
			}));
	...
	var xc = function(e, t) {
		return a(this, void 0, void 0, (function() {
			...
			return o(this, (function(o) {
				switch (o.label) {
					case 0:
						return n = ka(e, "x", "setdiff1d"), r = ka(t, "y",
							"setdiff1d"), g(n.dtype === r.dtype, (
					function() {
					...
					case 2:
						for (i = o.sent(), s = new Set(i), u = 0, h = 0; h < a
							.length; h++) s.has(a[h]) || u++;
						for (c = new Gr([u], n.dtype), l = new Gr([u], "int32"),
							h =
							0, f = 0; h < a.length; h++) s.has(a[h]) || (c
							.values[
								f] = a[h], l.values[f] = h, f++);
	...
	var _c = Sa({
		slice1d_: function(e, t, n) {
			...
			return g(1 === r.rank, (function() {
				return "slice1d expects a rank-1 tensor, but got a rank-".concat(r
					.rank,
					" tensor")
			})), fi(r, [t], [n])
		}
	...
	var Ic = Sa({
		slice2d_: function(e, t, n) {
			...
			return g(2 === r.rank, (function() {
				return "slice2d expects a rank-2 tensor, but got a rank-".concat(r
					.rank,
					" tensor")
			})), fi(r, t, n)
		}
	...
	var Nc = Sa({
		slice3d_: function(e, t, n) {
			...
			return g(3 === r.rank, (function() {
				return "slice3d expects a rank-3 tensor, but got a rank-".concat(r
					.rank,
					" tensor")
			})), fi(r, t, n)
		}
	...
	var Mc = Sa({
		slice4d_: function(e, t, n) {
			...
			return g(4 === r.rank, (function() {
				return "slice4d expects a rank-4 tensor, but got a rank-".concat(r
					.rank,
					" tensor")
			})), fi(r, t, n)
		}
	...
	var Cc = Sa({
		rfft_: function(e, t) {
			...
			if (null != t && t < r) {
				...
				s[e.shape.length - 1] = t - r, n = ci([e, au(s)], e.shape.length - 1), r = t
			} else n = e;
			var u = $i(n),
				c = ii(Aa(n, u), [a, r]),
				l = Dc(c),
	...
	var Pc = Sa({
		squaredDifference_: function(e, t) {
			var n, r = ka(e, "a", "squaredDifference"),
	...
	var Lc = Sa({
		stack_: function(e, t) {
			...
			})), n.length > 0 && g(t <= n[0].rank, (function() {
				return "Axis must be <= rank of the tensor"
			}));
			var r = n,
				a = {
	...
	var Uc = Sa({
		stridedSlice_: function(e, t, n, r, a, o, i, s, u) {
			void 0 === a && (a = 0), void 0 === o && (o = 0), void 0 === i && (i = 0),
				void 0 ===
				s && (s = 0), void 0 === u && (u = 0);
			var c = {
					x: ka(e, "x", "stridedSlice", "string_or_numeric")
				},
				l = {
					begin: t,
					end: n,
	...
	function qc(e, t, n) {
		if (m(e), null != t && 2 !== t.length) throw new Error(
	...
	function Kc(e, t, n) {
		if (m(e), null != t && 3 !== t.length) throw new Error(
	...
	function Vc(e, t, n) {
		...
		for (var i = 0; i < a; ++i)
			if (n.shape[i] !== t.shape[i]) throw new Error(o + " updates.shape[".concat(i, "] (").concat(n
				.shape[i], ") != indices.shape[").concat(i, "] (").concat(t.shape[i], ")."));
		for (i = 0; i < n.rank - a; ++i)
			if (n.shape[i + a] !== e[i + r]) throw new Error(o + " updates.shape[".concat(i + a, "] (")
				.concat(n
					.shape[i + a], ") != shape[").concat(i + a, "] (").concat(e[i + a], ")"))
	}
	...
	function Hc(e, t, n) {
		...
		if ("int32" !== t.dtype) throw new Error("The dtype of 'indices' should be int32, but got dtype: "
			.concat(t.dtype));
		if (n.length < 1) throw new Error("Output rank must be greater or equal to 1, but got shape: "
			.concat(
				n));
		if (0 === n.length) {
	...
	function jc(e, t, n) {
		for (var r = t.shape.length, a = r > 1 ? t.shape[r - 1] : 1, o = n.length, i = 1, c = a; c < o; ++c)
			i *= n[c];
		var l = a < 1 ? 1 : a;
		return {
			sliceRank: a,
	...
	var Zc = Sa({
		tensorScatterUpdate_: function(e, t, n) {
			...
			if (Hc(o, a, r.shape), r.dtype !== o.dtype) throw new Error(
				"tensor and updates must have the same dtype, instead they are ".concat(
					r
	...
	var Xc = Sa({
		truncatedNormal_: function(e, t, n, r, a) {
			...
			for (var o = new ec(t, n, r, !0, a), i = _o(e, r), s = 0; s < i.values.length; s++)
				i
				.values[s] = o.nextValue();
			return i.toTensor()
		}
	...
	var nl = function(e) {
		return a(this, void 0, void 0, (function() {
			...
			return o(this, (function(a) {
				switch (a.label) {
					case 0:
						return [4, (t = ka(e, "condition", "whereAsync",
								"bool"))
							.data()
						];
					case 1:
						return n = a.sent(), r = tl(t.shape, n), e !== t && t
							.dispose(), [2, r]
				}
			}))
		}))
	...
	var rl = function(e, t, n) {
		return a(this, void 0, void 0, (function() {
			...
			return o(this, (function(o) {
				switch (o.label) {
					case 0:
						for (r = ka(e, "tensor", "boolMask"), a = ka(t, "mask",
								"boolMask", "bool"), i = null == n ? 0 : n, s =
							a
							.rank, u = r.shape, g(s > 0, (function() {
								return "mask cannot be scalar"
							})), v(u.slice(i, i + s), a.shape,
								"mask's shape must match the first K dimensions of tensor's shape,"
							), c = 1, l = i; l < i + s; l++) c *= u[l];
						return h = u.slice(0, i).concat([c], u.slice(i + s)),
							f =
							ii(r, h), d = ii(a, [-1]), [4, nl(d)];
					case 1:
						return p = o.sent(), m = Oc(p, [1]), y = As(f, m, i),
							e !==
							r && r.dispose(), t !== a && a.dispose(), m
							.dispose(), f
							.dispose(), d.dispose(), p.dispose(), [2, y]
				}
			}))
		}))
	};
	var al = Sa({
		transpose_: function(e, t, n) {
			...
			if (null == t && (t = r.shape.map((function(e, t) {
					return t
				})).reverse()), g(r.rank === t.length, (function() {
			...
			return "complex64" === r.dtype ? Ta((function() {
				var e = cc(r),
					t = Ns(r);
				return e = da.runKernel(xn, {
					x: e
				}, o), t = da.runKernel(xn, {
					x: t
				}, o), n && (t = Ws(t)), Aa(e, t)
	...
	var ol = Sa({
		movingAverage_: function(e, t, n, r, a) {
			...
			aa(o, i), g(w(o.shape, i.shape), (function() {
		...
		sparseToDense_: function(e, t, n, r) {
			...
			! function(e, t, n, r) {
				...
				if (n.length !== o) throw new Error(
					"outputShape has incorrect number of elements:," + " ".concat(n
						.length,
						", should be: ").concat(o, "."));
				var i = t.size;
				if (0 !== t.rank && (1 !== t.rank || i !== a)) throw new Error(
	...
	var ul = Sa({
		gatherND_: function(e, t) {
			var n = ka(t, "indices", "gatherND", "int32"),
				r = {
					params: ka(e, "x", "gatherND", "string_or_numeric"),
					indices: n
				};
		...
		dropout_: function(e, t, n, r) {
			...
			if (g("float32" === a.dtype, (function() {
					...
					return "rate must be a float in the range [0, 1), but got ".concat(
						t,
						".")
				})), 0 === t) return e instanceof Vr ? a.clone() : a;
			var o = function(e, t) {
					if (null == t) return e.shape.slice();
					if (w(e.shape, t)) return t;
					if (e.shape.length === t.length) {
						for (var n = [], r = 0; r < e.shape.length; r++) null == t[r] && null !=
							e
	...
	var fl = function(e, t, n) {
		return void 0 === n && (n = 1), a(this, void 0, void 0, (function() {
			...
			return o(this, (function(o) {
				switch (o.label) {
					case 0:
						return r = ka(e, "predictions", "inTopK"), a = ka(t,
							"targets", "inTopK"), g(r.rank > 1, (
					function() {
					...
					case 2:
						for (c = o.sent(), l = s([u.length / i, i], 2), h = l[
							0],
							f = l[1], d = A("bool", h), p = 0; p < h; p++) {
							for (m = p * f, y = u.subarray(m, m + f), b = [],
								w =
								0; w < y.length; w++) b.push({
								value: y[w],
								index: w
							});
						...
						return e !== r && r.dispose(), t !== a && a.dispose(), [
							2,
							Ia(d, a.shape, "bool")
						]
				}
	...
	var dl = Sa({
		conv2DBackpropFilter_: function(e, t, n, r, a, o, i) {
			...
			var u = t;
			3 === u.rank && (u = ii(t, [1, t.shape[0], t.shape[1], t.shape[2]])), g(4 === s
				.rank, (
					function() {
			...
			g(c === n[2], (function() {
				...
				return "Error in conv2dDerFilter: depth of dy (".concat(l,
						") must ") +
	...
	var yl = Sa({
		fusedConv2d_: function(e) {
			...
			if (p = p || "linear", !1 === ml(da.state.gradientDepth, p)) {
				g("NHWC" === u, (function() {
					return "Error in fused conv2d: got dataFormat of ".concat(u,
							" but ") +
			...
			var b = ka(n, "x", "conv2d", "float32"),
				...
				k = b,
				x = !1;
			3 === b.rank && (x = !0, k = ii(b, [1, b.shape[0], b.shape[1], b.shape[2]])), g(
				4 === k
				.rank, (function() {
			...
			g(w.shape[2] === E, (function() {
				return "Error in conv2d: depth of input (".concat(E,
						") must match ") +
			...
			var S, A, _ = Jo(k.shape, w.shape, a, l, o, h);
			if (null != f && (t = s(ra(S = ka(f, "bias", "fused conv2d"), b), 1), S = t[0],
					"NHWC" === u ? Zi(_.outShape, S.shape) : (g(S.shape.length <= 1, (
				function() {
					...
					})), g(0 === S.shape.length || S.shape[0] === _.outChannels || 1 === S
						.shape[0], (function() {
							return "Error in fused conv2d: bias shape (".concat(S.shape,
									") is not ") +
								"compatible with the number of output channels " + "("
								.concat(_.outChannels, ")")
						})))), null != v) {
				var I = v.shape;
				if (g(I.length <= 1 || 3 === I.length, (function() {
					...
					})), 1 === I.length) g(1 === I[0] || I[0] === _.outChannels, (function() {
					return "Error in fused conv2d: PReLU activation weights " + "("
						.concat(I,
						") is not compatible with the number of output ") +
						"channels (".concat(_.outChannels, ").")
				}));
				else if (3 === I.length) try {
					Zi(I, _.outShape)
				} catch (e) {
					var N = "Error in fused conv2d: PReLU activation weights (".concat(I,
							") ") +
			...
			var M = function(e, t) {
					g("NHWC" === u, (function() {
						return "Error in gradient of fused conv2D: got dataFormat of "
							.concat(u, " but only NHWC is currently supported.")
					}));
					var n = s(t, 4),
						r = n[0],
						i = n[1],
			...
			if (null == f) {
				var R = zs((function(e, t, n) {
					...
					return n([t, e, r]), x && (r = ii(r, [r.shape[1], r.shape[2], r
						.shape[3]
					])), {
						value: r,
						gradFunc: M
			...
			var B = zs((function(e, t, n, r) {
				...
				return r([t, e, a, n]), x && (a = ii(a, [a.shape[1], a.shape[2], a
					.shape[3]
				])), {
					value: a,
					gradFunc: M
	...
	var wl = Sa({
		depthwiseConv2dNativeBackpropInput_: function(e, t, n, r, a, o, i) {
			...
			var s = t,
				u = !1;
			3 === t.rank && (u = !0, s = ii(t, [1, t.shape[0], t.shape[1], t.shape[2]]));
			var c = {
					dy: s,
					filter: n
				},
	...
	var kl = Sa({
		fusedDepthwiseConv2d_: function(e) {
			...
			})), null == l && (l = [1, 1]), g(ni(a, l), (function() {
			...
			var E, S, A = Jo(k.shape, w.shape, a, l, o, h, !0);
			null != f && (t = s(ra(E = ka(f, "bias", "fused conv2d"), b), 1), E = t[0], Zi(A
				.outShape, E.shape)), null != v && (S = ka(v, "prelu weights",
	...
	var xl = Sa({
			fusedMatMul_: function(e) {
				...
				var w = o ? m.shape[m.rank - 2] : m.shape[m.rank - 1],
					...
					I = y(A);
				g(w === k, (function() {
					return "Error in fused matMul: inner shapes (".concat(w,
						") and (") + ""
						.concat(k, ") of Tensors with shapes ").concat(m.shape,
						" and ") +
						"".concat(b.shape, " and transposeA=").concat(o) +
						" and transposeB=".concat(u, " must match.")
				}));
				var N, M, T = Zi(m.shape.slice(0, -2), b.shape.slice(0, -2)).concat([x, E]),
					D = ii(m, o ? [_, w, x] : [_, x, w]),
					R = ii(b, u ? [I, E, k] : [I, k, E]);
				null != c && (N = s(ra(N = ka(c, "bias", "fused matMul"), m), 1)[0], Zi(T, N
					.shape)),
				...
				var B = function(e, t) {
						...
						return o || u ? !o && u ? (n = li(p, l, !1, !1), r = li(p, i, !0, !1)) :
							o && !
							u ? (n = li(l, p, !1, !0), r = li(i, p, !1, !1)) : (n = li(l, p, !0, !
								0),
								r = li(p, i, !0, !0)) : (n = li(p, l, !1, !0), r = li(i, p, !0, !
							1)),
		...
		cropAndResize_: function(e, t, n, r, a, o) {
			...
			g(4 === i.rank, (function() {
				...
				return "Error in cropAndResize: boxes must be have size [".concat(c,
					",4] ") + "but had shape ".concat(s.shape, ".")
			})), g(1 === u.rank && u.shape[0] === c, (function() {
				return "Error in cropAndResize: boxInd must be have size [".concat(
					c,
	...
	function Bl(e, t, n, r, a, o) {
		...
		var i = e.shape[0];
		return n = Math.min(n, i), g(0 <= r && r <= 1, (function() {
			...
			return "scores has incompatible shape with boxes. Expected ".concat(i, ", ") +
	...
	function Ul(e, t, n, r, a, o, i, c, l) {
		void 0 === i && (i = !1), void 0 === c && (c = !1), void 0 === l && (l = !1);
		for (var h = [], f = 0; f < t.length; f++) t[f] > a && h.push({
			score: t[f],
			boxIndex: f,
			suppressBeginIndex: 0
		});
		h.sort(ql);
		for (var d = o > 0 ? -.5 / o : 0, p = [], g = []; p.length < n && h.length > 0;) {
			var v = h.pop(),
				m = v.score,
				y = v.boxIndex,
			...
			v.suppressBeginIndex = p.length, w || (v.score === m ? (p.push(y), g.push(v.score)) : v.score >
				a &&
				Cl(h, v, ql))
		}
		var E = p.length,
			S = n - E;
		c && S > 0 && (p.push.apply(p, u([], s(new Array(S).fill(0)), !1)), g.push.apply(g, u([], s(
			new Array(S)
			.fill(0)), !1)));
		var A = {
			selectedIndices: p
	...
	var Kl = function(e, t, n, r, i) {
		return void 0 === r && (r = .5), void 0 === i && (i = Number.NEGATIVE_INFINITY), a(this, void 0,
			void 0, (function() {
				var a, s, u, c, l, h, f;
				return o(this, (function(o) {
					switch (o.label) {
						case 0:
							return a = ka(e, "boxes", "nonMaxSuppressionAsync"), s =
								ka(
									t, "scores", "nonMaxSuppressionAsync"), u = Bl(
									a, s,
									n, r, i), n = u.maxOutputSize, r = u
								.iouThreshold,
								i = u.scoreThreshold, [4, Promise.all([a.data(), s
									.data()
								])];
						case 1:
							return c = o.sent(), l = c[0], h = c[1], f = Ol(l, h, n,
									r,
									i).selectedIndices, a !== e && a.dispose(),
								s !==
								t && s.dispose(), [2, Gc(f, "int32")]
					}
				}))
			}))
	};
	...
	var Hl = function(e, t, n, r, i, s) {
		return void 0 === r && (r = .5), void 0 === i && (i = Number.NEGATIVE_INFINITY), void 0 === s &&
			(
				s = 0), a(this, void 0, void 0, (function() {
				var a, u, c, l, h, f, d, p, g;
				return o(this, (function(o) {
					switch (o.label) {
						case 0:
							return a = ka(e, "boxes", "nonMaxSuppressionAsync"), u =
								ka(
									t, "scores", "nonMaxSuppressionAsync"), c = Bl(
									a, u,
									n, r, i, s), n = c.maxOutputSize, r = c
								.iouThreshold, i = c.scoreThreshold, s = c
								.softNmsSigma,
								[4, Promise.all([a.data(), u.data()])];
						case 1:
							return l = o.sent(), h = l[0], f = l[1], d = zl(h, f, n,
									r,
									i, s), p = d.selectedIndices, g = d
								.selectedScores,
								a !== e && a.dispose(), u !== t && u.dispose(), [2,
								{
									selectedIndices: Gc(p, "int32"),
									selectedScores: Gc(g)
								}]
					}
				}))
	...
	var Jl = function(e, t, n, r, i, u) {
		return void 0 === r && (r = .5), void 0 === i && (i = Number.NEGATIVE_INFINITY), void 0 === u &&
			(
				u = !1), a(this, void 0, void 0, (function() {
				var a, c, l, h, f, d, p, g, v, m, y, b;
				return o(this, (function(o) {
					switch (o.label) {
						case 0:
							return a = ka(e, "boxes", "nonMaxSuppressionAsync"), c =
								ka(
									t, "scores", "nonMaxSuppressionAsync"), l = Bl(
									a, c,
									n, r, i, null), h = l.maxOutputSize, f = l
								.iouThreshold, d = l.scoreThreshold, [4, Promise
									.all([a
										.data(), c.data()
									])
								];
						case 1:
							return p = s.apply(void 0, [o.sent(), 2]), g = p[0], v =
								p[
									1], m = Ll(g, v, h, f, d, u), y = m
								.selectedIndices,
								b = m.validOutputs, a !== e && a.dispose(), c !==
								t && c
								.dispose(), [2, {
	...
	var Zl = Sa({
		resizeBilinear_: function(e, t, n, r) {
			...
			var o = a,
				i = !1;
			3 === a.rank && (i = !0, o = ii(a, [1, a.shape[0], a.shape[1], a.shape[2]])), s(t,
				0);
			var u = {
					images: o
				},
	...
	var Xl = Sa({
		threshold_: function(e, t, n, r) {
			...
			var o, i, u, c, l = ka(e, "image", "threshold"),
				h = l.shape[0] * l.shape[1],
				f = Bo(Gc([r]), 255);
			if (g(3 === l.rank, (function() {
			...
			"otsu" === t && (f = function(e, t) {
				for (var n, r, a, o, i, s, u = Gc([-1]), c = Gc([0]), l = Gc([0]), h =
						0; h < e.size - 1; h++) {
					n = fi(e, 0, h + 1), r = fi(e, h + 1), i = Ro(gs(n), t), s = Ro(gs(
							r),
						t);
	...
	var Ql = Sa({
		transform_: function(e, t, n, r, a, o) {
			void 0 === n && (n = "nearest"), void 0 === r && (r = "constant"), void 0 === a && (
				a =
				0);
			...
			g(4 === i.rank, (function() {
				return "Error in transform: image must be rank 4," + "but got rank "
					.concat(i.rank, ".")
			})), g(2 === s.rank && (s.shape[0] === i.shape[0] || 1 === s.shape[0]) && 8 ===
				s
				.shape[1], (function() {
	...
	var $l = Sa({
		bandPart_: function(e, t, n) {
			...
			var a, o, i = r.shape,
				...
				c = u[0],
				l = u[1];
			"number" == typeof t ? (g(t % 1 == 0, (function() {
				...
				return "bandPart(): numLower (".concat(t, ")") +
					" must not be greater than the number of rows (".concat(c,
						").")
			})), a = ka(t < 0 ? c : t, "numLower", "bandPart")) : (g("int32" === t.dtype, (
				function() {
					return "bandPart(): numLower's dtype must be an int32."
				})), a = Qi(Bs(t, 0), c, iu(t, c))), "number" == typeof n ? (g(n % 1 == 0, (
				function() {
				...
				return "bandPart(): numUpper (".concat(n, ")") +
					" must not be greater than the number of columns (".concat(
						l,
						").")
			})), o = ka(n < 0 ? l : n, "numUpper", "bandPart")) : (g("int32" === n.dtype, (
				function() {
			...
			var h = ii(uc(0, c, 1, "int32"), [-1, 1]),
				...
				v = au([c, l], r.dtype);
			return ii(Lc(el(ii(r, [-1, c, l])).map((function(e) {
				return Qi(p, e, v)
			}))), i)
		}
	});
	var eh = Sa({
		gramSchmidt_: function(e) {
			var t;
			if (Array.isArray(e)) {
				t = !1, g(null != e && e.length > 0, (function() {
			...
			} else t = !0, e = Fc(e, e.shape[0], 0).map((function(e) {
				return Oc(e, [0])
			}));
			g(e.length <= e[0].shape[0], (function() {
				return "Gram-Schmidt: Number of vectors (".concat(e.length,
					") exceeds ") + "number of dimensions (".concat(e[0].shape[
						0],
					").")
			}));
			var o = [],
	...
	function th(e, t) {
		return void 0 === t && (t = !1), da.tidy((function() {
			g(2 === e.shape.length, (function() {
				return "qr2d() requires a 2D Tensor, but got a ".concat(e.shape
					.length,
					"D Tensor.")
			}));
			for (var n = e.shape[0], r = e.shape[1], a = Es(n), o = No(e), i = qc([
					[1]
				], [1, 1]), u = No(i), c = n >= r ? r : n, l = function(e) {
					var t, c = o,
						l = u,
						h = a;
					t = s(da.tidy((function() {
						var t = fi(o, [e, e], [n - e, 1]),
							...
							h = Ks(c, Bo(l, s)),
							f = Ro(t, h);
						u = 1 === f.shape[0] ? No(i) : ci([i, fi(f, [1, 0],
							[f
								.shape[0] - 1, f.shape[1]
							])], 0);
						...
						return [u, o, a]
					})), 3), u = t[0], o = t[1], a = t[2], Da([c, l, h])
				}, h = 0; h < c; ++h) l(h);
			return !t && n > r && (a = fi(a, [0, 0], [n, r]), o = fi(o, [0, 0], [r, r])), [a, o]
		}))
	}
	var nh, rh = Sa({
		qr_: function(e, t) {
			if (void 0 === t && (t = !1), g(e.rank >= 2, (function() {
					return "qr() requires input tensor to have a rank >= 2, but got rank "
						.concat(e.rank)
				})), 2 === e.rank) return th(e, t);
			var n = e.shape.slice(0, e.shape.length - 2).reduce((function(e, t) {
					return e * t
				})),
				r = el(ii(e, [n, e.shape[e.shape.length - 2], e.shape[e.shape.length - 1]]), 0),
				a = [],
				o = [];
	...
	e.Reduction = void 0, (nh = e.Reduction || (e.Reduction = {}))[nh.NONE = 0] = "NONE", nh[nh.MEAN = 1] =
		"MEAN", nh[nh.SUM = 2] = "SUM", nh[nh.SUM_BY_NONZERO_WEIGHTS = 3] = "SUM_BY_NONZERO_WEIGHTS";
	var ah = Sa({
	...
	var oh = Sa({
		absoluteDifference_: function(t, n, r, a) {
			...
			var o = ka(t, "labels", "absoluteDifference"),
				...
				s = null;
			null != r && (s = ka(r, "weights", "absoluteDifference")), v(o.shape, i.shape,
	...
	var ih = Sa({
		cosineDistance_: function(t, n, r, a, o) {
			...
			var i = ka(t, "labels", "cosineDistance"),
				...
				u = null;
			null != a && (u = ka(a, "weights", "cosineDistance")), v(i.shape, s.shape,
	...
	var sh = Sa({
		hingeLoss_: function(t, n, r, a) {
			...
			var o = ka(t, "labels", "hingeLoss"),
				...
				s = null;
			null != r && (s = ka(r, "weights", "hingeLoss")), v(o.shape, i.shape,
				"Error in hingeLoss: ");
			var u = fs(1);
			o = Ks(Bo(fs(2), o), u);
	...
	var uh = Sa({
		huberLoss_: function(t, n, r, a, o) {
			void 0 === a && (a = 1), void 0 === o && (o = e.Reduction.SUM_BY_NONZERO_WEIGHTS);
			var i = ka(t, "labels", "huberLoss"),
				s = ka(n, "predictions", "huberLoss"),
				u = null;
			null != r && (u = ka(r, "weights", "huberLoss")), v(i.shape, s.shape,
				"Error in huberLoss: ");
			var c = fs(a),
				l = Fo(Ks(s, i)),
				h = iu(l, c),
				f = Ks(l, h),
				d = To(Bo(fs(.5), ps(h)), Bo(c, f));
			return ah(d, u, o)
		}
	});
	var ch = Sa({
		logLoss_: function(t, n, r, a, o) {
			void 0 === a && (a = 1e-7), void 0 === o && (o = e.Reduction
			.SUM_BY_NONZERO_WEIGHTS);
			var i = ka(t, "labels", "logLoss"),
				s = ka(n, "predictions", "logLoss"),
				u = null;
			null != r && (u = ka(r, "weights", "logLoss")), v(i.shape, s.shape,
				"Error in logLoss: ");
			var c = fs(1),
				l = fs(a),
				h = Ws(Bo(i, Ps(To(s, l)))),
	...
	var lh = Sa({
		meanSquaredError_: function(t, n, r, a) {
			...
			var o = ka(t, "labels", "meanSquaredError"),
				...
				s = null;
			null != r && (s = ka(r, "weights", "meanSquaredError")), v(o.shape, i.shape,
	...
	var hh = Sa({
		sigmoidCrossEntropy_: function(t, n, r, a, o) {
			void 0 === a && (a = 0), void 0 === o && (o = e.Reduction.SUM_BY_NONZERO_WEIGHTS);
			var i = ka(t, "multiClassLabels", "sigmoidCrossEntropy"),
				s = ka(n, "logits", "sigmoidCrossEntropy"),
				u = null;
			if (null != r && (u = ka(r, "weights", "sigmoidCrossEntropy")), v(i.shape, s.shape,
					"Error in sigmoidCrossEntropy: "), a > 0) {
				var c = fs(a),
					l = fs(1),
					h = fs(.5);
	...
	var fh = Sa({
		softmaxCrossEntropy_: function(t, n, r, a, o) {
			...
			var i = ka(t, "onehotLabels", "softmaxCrossEntropy"),
				...
				c = null;
			if (null != r && (c = ka(r, "weights", "softmaxCrossEntropy")), v(i.shape, u.shape,
					"Error in softmaxCrossEntropy: "), a > 0) {
				var l = fs(a),
					h = fs(1),
					f = fs(i.shape[1]);
			...
			var d = function(e, t, n) {
				if (void 0 === n && (n = -1), -1 === n && (n = t.rank - 1), n !== t.rank -
					1)
					throw Error(
					...
					return {
						...
						gradFunc: function(e, t) {
							var r = s(t, 2),
								...
								o = r[1],
								i = us(e.shape, [n]);
							return [Bo(ii(e, i), Ks(Io(a, "float32"), bs(
									o))),
								Bo(ii(e, i), Ks(bs(o), Io(a,
									"float32")))
							]
						}
					}
	...
	var dh = Sa({
		sparseFillEmptyRows_: function(e, t, n, r) {
			...
			if (1 !== o.rank) throw new Error("Values should be Tensor1D but received shape "
				.concat(o.shape));
			if (1 !== i.rank) throw new Error(
				"Dense shape should be Tensor1D but received shape "
				.concat(i.shape));
			if (0 !== s.rank) throw new Error(
				"Default value should be a scalar but received shape "
				.concat(s.shape));
			var u = {
					indices: a,
					values: o,
		...
		Sh = {
			...
			stringSplit: Sa({
				stringSplit_: function(e, t, n) {
					...
					if (1 !== r.rank) throw new Error(
						"Input should be Tensor1D but received shape "
						.concat(r.shape));
	...
	function Mh(e, t, n) {
		...
		})), "undefined" == typeof t && (t = "Custom"), "undefined" == typeof n && (n = e.className);
		var r = t + ">" + n;
	...
	var Th = {
		...
		Dh = function(e) {
			...
			return r(t, e), t.prototype.minimize = function(e, t, n) {
				void 0 === t && (t = !1);
				...
				return a(this, void 0, void 0, (function() {
					return o(this, (function(e) {
						return null == this.iterations_ && (this.iterations_ =
							0), [
							2, {
								name: "iter",
								tensor: fs(this.iterations_, "int32")
							}
						]
					}))
				}))
				...
				return a(this, void 0, void 0, (function() {
					...
					return o(this, (function(n) {
						switch (n.label) {
							...
							case 1:
								return t.iterations_ = n.sent()[0], [2, e.slice(
									1)]
						}
					}))
				}))
	...
	var Rh = function(e) {
			function t(t, n, r) {
				...
				return a.learningRate = t, a.rho = n, a.epsilon = r, a.accumulatedGrads = [], a
					.accumulatedUpdates = [], null == r && (a.epsilon = da.backend.epsilon()), a
			}
			return r(t, e), Object.defineProperty(t, "className", {
				get: function() {
					return "Adadelta"
				},
				enumerable: !1,
					...
					if (null != o) {
						...
						Ta((function() {
							var e = To(Bo(i, t.rho), Bo(ps(o), 1 - t.rho)),
								n = Bo(Ro(ds(To(s, t.epsilon)), ds(To(i, t
									.epsilon))), o),
				...
				null != this.accumulatedUpdates && (Da(this.accumulatedGrads.map((function(e) {
					return e.variable
				}))), Da(this.accumulatedUpdates.map((function(e) {
					return e.variable
				}))))
			}, t.prototype.getWeights = function() {
				return a(this, void 0, void 0, (function() {
					...
					return o(this, (function(t) {
						switch (t.label) {
							case 0:
								return e = u(u([], s(this.accumulatedGrads), !
									1), s(
										this.accumulatedUpdates), !1), [4,
									this
									.saveIterations()
								];
							case 1:
								return [2, [t.sent()].concat(e.map((function(
								e) {
									return {
										name: e
											.originalName,
				...
				return a(this, void 0, void 0, (function() {
					...
					return o(this, (function(n) {
						switch (n.label) {
							...
							case 1:
								return e = n.sent(), t = e.length / 2, !1, this
									.accumulatedGrads = e.slice(0, t).map((
										function(
											e) {
											return {
												originalName: e.name,
												variable: e.tensor.variable(
													false)
											}
										})), this.accumulatedUpdates = e.slice(
										t, 2 * t)
									.map((function(e) {
										return {
											originalName: e.name,
		...
		Bh = function(e) {
			function t(t, n) {
				...
				return r.learningRate = t, r.initialAccumulatorValue = n, r.accumulatedGrads = [], r
			}
			return r(t, e), Object.defineProperty(t, "className", {
				get: function() {
					return "Adagrad"
				...
				(Array.isArray(e) ? e.map((function(e) {
					...
					if (null != o) {
						...
						Ta((function() {
							var e = To(i, ps(o));
							i.assign(e);
							var n = To(Bo(Ro(o, ds(To(e, da.backend
							.epsilon()))), -t
								.learningRate), a);
							a.assign(n)
						}))
				...
				null != this.accumulatedGrads && Da(this.accumulatedGrads.map((function(e) {
					return e.variable
				})))
			}, t.prototype.getWeights = function() {
				return a(this, void 0, void 0, (function() {
					...
					return o(this, (function(t) {
						switch (t.label) {
							case 0:
								return [4, this.extractIterations(e)];
							case 1:
								return e = t.sent(), !1, this.accumulatedGrads =
									e
									.map((function(e) {
										return {
											originalName: e.name,
		...
		Fh = function(e) {
			function t(t, n, r, a) {
				...
				return o.learningRate = t, o.beta1 = n, o.beta2 = r, o.epsilon = a, o
					.accumulatedFirstMoment = [], o.accumulatedSecondMoment = [], Ta((function() {
						o.accBeta1 = fs(n).variable(), o.accBeta2 = fs(r).variable()
					})), null == a && (o.epsilon = da.backend.epsilon()), o
			}
			return r(t, e), Object.defineProperty(t, "className", {
				get: function() {
					return "Adam"
				...
				Ta((function() {
					...
					n.forEach((function(n, o) {
						...
						null == t.accumulatedFirstMoment[o] && (t
							.accumulatedFirstMoment[o] = {
								originalName: "".concat(n, "/m"),
								variable: Ta((function() {
									return $i(i).variable(false)
								}))
							}), null == t.accumulatedSecondMoment[o] && (t
							.accumulatedSecondMoment[o] = {
						...
						if (null != s) {
							...
							var p = To(Bo(Ro(f, To(ds(d), t.epsilon)), -t
								.learningRate), i);
							i.assign(p)
						}
					})), t.accBeta1.assign(Bo(t.accBeta1, t.beta1)), t.accBeta2.assign(
						Bo(t
							.accBeta2, t.beta2))
				})), this.incrementIterations()
			}, t.prototype.dispose = function() {
				this.accBeta1.dispose(), this.accBeta2.dispose(), null != this.accumulatedFirstMoment &&
					Da(
						this.accumulatedFirstMoment.map((function(e) {
							return e.variable
						}))), null != this.accumulatedSecondMoment && Da(this.accumulatedSecondMoment
						.map((
							function(e) {
								return e.variable
							})))
						...
						switch (t.label) {
							case 0:
								return e = u(u([], s(this
										...
										1), s(this.accumulatedSecondMoment),
									!1), [
					...
					return o(this, (function(r) {
						switch (r.label) {
							case 0:
								return [4, this.extractIterations(e)];
							case 1:
								return e = r.sent(), Ta((function() {
										n.accBeta1.assign(hs(n.beta1, n
												.iterations_ + 1)), n
											.accBeta2.assign(hs(n.beta2,
												n
												.iterations_ + 1))
									})), t = e.length / 2, !1, this
									.accumulatedFirstMoment = e.slice(0, t).map(
										(
											function(e) {
												return {
													originalName: e.name,
		...
		Ch = function(e) {
			function t(t, n, r, a, o) {
				...
				return i.learningRate = t, i.beta1 = n, i.beta2 = r, i.epsilon = a, i.decay = o, i
					.accumulatedFirstMoment = [], i.accumulatedWeightedInfNorm = [], Ta((function() {
						i.iteration = fs(0).variable(), i.accBeta1 = fs(n).variable()
					})), null == a && (i.epsilon = da.backend.epsilon()), i
			}
			return r(t, e), Object.defineProperty(t, "className", {
				get: function() {
					return "Adamax"
				...
				Ta((function() {
					...
					n.forEach((function(n, o) {
						...
						if (null != s) {
							...
							var p = To(Bo(Ro(a, r), Ro(l, To(d, t.epsilon))),
							i);
							i.assign(p)
						}
					})), t.iteration.assign(To(t.iteration, 1)), t.accBeta1.assign(Bo(t
						.accBeta1, t.beta1))
				})), this.incrementIterations()
			}, t.prototype.dispose = function() {
				this.accBeta1.dispose(), this.iteration.dispose(), null != this
					.accumulatedFirstMoment &&
					Da(this.accumulatedFirstMoment.map((function(e) {
						return e.variable
					}))), null != this.accumulatedWeightedInfNorm && Da(this.accumulatedWeightedInfNorm
						.map(
							(function(e) {
								return e.variable
							})))
		...
		Ph = function(e) {
			...
			return r(t, e), Object.defineProperty(t, "className", {
				...
				this.learningRate = e, null != this.c && this.c.dispose(), this.c = Ra(fs(-e))
			}, t.prototype.dispose = function() {
				this.c.dispose()
			}, t.prototype.getWeights = function() {
				return a(this, void 0, void 0, (function() {
		...
		Oh = function(e) {
			function t(t, n, r) {
				...
				return a.learningRate = t, a.momentum = n, a.useNesterov = r, a.accumulations = [], a.m =
					fs(a
						.momentum), a
			}
			return r(t, e), Object.defineProperty(t, "className", {
				...
				(Array.isArray(e) ? e.map((function(e) {
					...
					null != i && Ta((function() {
						var e, n = To(Bo(t.m, o), i);
						e = t.useNesterov ? To(Bo(t.c, To(i, Bo(n, t.m))), a) :
							To(
								Bo(t.c, n), a), o.assign(n), a.assign(e)
					}))
				})), this.incrementIterations()
			}, t.prototype.dispose = function() {
				this.m.dispose(), null != this.accumulations && Da(this.accumulations.map((function(e) {
					return e.variable
				})))
					...
					return o(this, (function(e) {
						switch (e.label) {
							case 0:
								return [4, this.saveIterations()];
							case 1:
								return [2, [e.sent()].concat(this.accumulations
									.map(
										(function(e) {
											return {
												name: e
					...
					return o(this, (function(t) {
						switch (t.label) {
							case 0:
								return [4, this.extractIterations(e)];
							case 1:
								return e = t.sent(), !1, this.accumulations = e
									.map(
										(function(e) {
											return {
												originalName: e.name,
		...
		Lh = function(e) {
			function t(t, n, r, a, o) {
				void 0 === n && (n = .9), void 0 === r && (r = 0), void 0 === a && (a = null), void 0 ===
					o && (
						o = !1);
				var i = e.call(this) || this;
				if (i.learningRate = t, i.decay = n, i.momentum = r, i.epsilon = a, i
					.accumulatedMeanSquares = [], i.accumulatedMoments = [], i.accumulatedMeanGrads = [], i
					.centered = o, null == a && (i.epsilon = da.backend.epsilon()), null == t)
				throw new Error(
			...
			return r(t, e), Object.defineProperty(t, "className", {
				...
				(Array.isArray(e) ? e.map((function(e) {
					...
					}), null == t.accumulatedMeanGrads[r] && t.centered && (t
						.accumulatedMeanGrads[r] = {
						...
						Ta((function() {
							...
							if (t.centered) {
								var n = t.accumulatedMeanGrads[r].variable,
									...
									c = Ro(Bo(i, t.learningRate), ds(Ks(e, To(
										ps(o),
										t.epsilon)))),
								...
								var f = To(Bo(s, t.decay), Bo(ps(i), 1 - t
									.decay));
								l = To(Bo(u, t.momentum), Ro(Bo(i, t
										.learningRate),
									ds(To(f, t.epsilon))));
				...
				null != this.accumulatedMeanSquares && Da(this.accumulatedMeanSquares.map((function(e) {
					return e.variable
				}))), null != this.accumulatedMeanGrads && this.centered && Da(this
					.accumulatedMeanGrads
					.map((function(e) {
						return e.variable
					}))), null != this.accumulatedMoments && Da(this.accumulatedMoments.map((
					function(
						e) {
						return e.variable
					})))
						...
						switch (t.label) {
							case 0:
								return e = u(u([], s(this
										...
										1), s(this.accumulatedMoments), !1),
									this
									.centered && e.push.apply(e, u([], s(this
										.accumulatedMeanGrads), !1)), [4, this
										.saveIterations()
									];
							case 1:
								return [2, [t.sent()].concat(e.map((function(
					...
					return o(this, (function(r) {
						switch (r.label) {
							case 0:
								return [4, this.extractIterations(e)];
							case 1:
								return e = r.sent(), t = this.centered ? e
									.length /
									3 : e.length / 2, n = !1, this
									.accumulatedMeanSquares = e.slice(0, t).map(
										(
											function(e) {
												return {
													originalName: e.name,
									...
									.slice(t,
										...
										.accumulatedMeanGrads = e.slice(2 * t,
											3 *
											t).map((function(e) {
											return {
												originalName: e.name,
	...
	var Wh = function() {
		function e(t) {
			...
			t.startsWith(e.URL_SCHEME) && (t = t.slice(e.URL_SCHEME.length)), null != t && 0 !== t
				.length ||
				(t = "model"), this.modelJsonFileName = t + ".json", this.weightDataFileName = t +
				".weights.bin"
		}
		return e.prototype.save = function(e) {
			return a(this, void 0, void 0, (function() {
				...
				return o(this, (function(o) {
					switch (o.label) {
						case 0:
							...
							if (t = Ma.join(e.weightData), n = window.URL
								.createObjectURL(new Blob([t], {
									type: "application/octet-stream"
								})), !(e
									.modelTopology instanceof ArrayBuffer))
								return [3, 1];
							throw new Error(
						...
						case 1:
							return r = [{
								...
								}], a = Ka(e, r), i = window.URL
								.createObjectURL(new Blob([JSON.stringify(
									a)], {
									type: "application/json"
								})), (s = null == this.modelJsonAnchor ?
									document.createElement("a") : this
									.modelJsonAnchor).download = this
								.modelJsonFileName, s.href = i, [4, Uh((
									function() {
						...
						case 2:
							return o.sent(), null == e.weightData ? [3, 4] :
								((
										u = null == this.weightDataAnchor ?
										document.createElement("a") : this
										.weightDataAnchor).download = this
									.weightDataFileName, u.href = n, [4, Uh(
										(
											function() {
	...
	var Gh = function() {
		function e(e) {
			if (null == e || e.length < 1) throw new Error(
		...
		return e.prototype.load = function() {
			...
			try {
				for (var c = i(e), l = c.next(); !l.done; l = c.next()) {
					var h = l.value;
					a.push.apply(a, u([], s(h.weights), !1)), o.push.apply(o, u([], s(h.paths), !1))
				}
			} catch (e) {
				t = {
					error: e
			...
			try {
				for (var u = i(e), c = u.next(); !c.done; c = u.next()) {
					c.value.paths.forEach((function(e) {
						var t = qa(e);
						if (-1 !== a.indexOf(t)) throw new Error(
							"Duplicate file basename found in weights manifest: " +
							"'".concat(t, "'"));
						if (a.push(t), -1 === o.indexOf(t)) throw new Error(
							"Weight file with basename '".concat(t,
								"' is not provided."));
			...
			if (a.length !== this.weightsFiles.length) throw new Error(
				"Mismatch in the number of files in weights manifest " + "(".concat(a
					.length,
					") and the number of weight files provided ") + "(".concat(this
					.weightsFiles
					.length, ")."));
			return s
		}, e
	...
	function qh(e, t, n, r) {
		...
		function(e, t) {
			g(e >= 0 && e <= 1, (function() {
				return "Progress fraction must be in range [0, 1], but " + "got startFraction "
					.concat(e)
			})), g(t >= 0 && t <= 1, (function() {
				return "Progress fraction must be in range [0, 1], but " + "got endFraction "
					.concat(t)
			})), g(t >= e, (function() {
				return "startFraction must be no more than endFraction, but " +
					"got startFraction "
					.concat(e, " and endFraction ") + "".concat(t)
			}))
	...
	function Kh(e, t) {
		return a(this, void 0, void 0, (function() {
			...
			return o(this, (function(o) {
				switch (o.label) {
					case 0:
						return null == t && (t = {}), n = null == t.fetchFunc ? TTWebAssembly.fetch : t.fetchFunc, r = e.map((function(e) {
								return n(e, t.requestInit, {
									isBinary: !0
								})
							})), a = 0, i = .5, null != t.onProgress ? [3, 2] : [4,
								Promise.all(r)
							];
					case 1:
						return s = o.sent(), [3, 4];
					...
					case 4:
						...
						})), c = .5, l = 1, null != t.onProgress ? [3, 6] : [4,
							Promise.all(u)
						];
					case 5:
						return h = o.sent(), [3, 8];
	...
	function Vh(e) {
		...
		return function(n, r, i) {
			return void 0 === r && (r = ""), a(t, void 0, void 0, (function() {
				...
				return o(this, (function(o) {
					switch (o.label) {
						case 0:
							if (t = n.map((function() {
									return !1
								})), a = {}, s = null != i ? i.map((function() {
									return !1
								})) : [], u = [], n.forEach((function(e, n) {
									var r = 0;
								...
								"".concat(u.join(", "), "."));
							return l = t.reduce((function(e, t, n) {
								return t && e.push(n), e
						...
						case 1:
							return f = o.sent(), d = {}, p = 0, l.forEach((
								function(
									e) {
	...
	Za.registerSaveRouter((function(e) {
		return Z().getBool("IS_BROWSER") && !Array.isArray(e) && e.startsWith(Wh.URL_SCHEME) ?
			function(e) {
				void 0 === e && (e = "model");
				return new Wh(e)
			}(e.slice(Wh.URL_SCHEME.length)) : null
	}));
	var Hh = function() {
		function e(e, t) {
			if (this.DEFAULT_METHOD = "POST", null == t && (t = {}), this.weightPathPrefix = t
				.weightPathPrefix, this.weightUrlConverter = t.weightUrlConverter, null != t.fetchFunc ?
				(g(
					"function" == typeof t.fetchFunc, (function() {
						return "Must pass a function that matches the signature of `fetch` (see https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API)"
					})), this.fetch = t.fetchFunc) : this.fetch = TTWebAssembly.fetch, g(null != e && e
					.length > 0, (function() {
						return "URL path for http must not be null, undefined or empty."
					})), Array.isArray(e) && g(2 === e.length, (function() {
					return "URL paths for http must have a length of 2, " + "(actual length is "
						.concat(e.length, ").")
				})), this.path = e, null != t.requestInit && null != t.requestInit.body)
			throw new Error(
		...
		return e.prototype.save = function(e) {
						...
						case 0:
							...
							return (t = Object.assign({
								...
								n = [{
									...
									weights: e.weightSpecs
								}], r = Ka(e, n), t.body.append(
									"model.json",
									new Blob([JSON.stringify(r)], {
										type: "application/json"
									}), "model.json"), null != e
								.weightData && (
									a = Ma.join(e.weightData), t.body
									.append(
										"model.weights.bin", new Blob([a], {
											type: "application/octet-stream"
										}), "model.weights.bin")), [4, this
									.fetch(this.path, t)
								];
						case 1:
			...
			return a(this, void 0, void 0, (function() {
				...
				return o(this, (function(o) {
					switch (o.label) {
						case 0:
							return [4, this.fetch(this.path, this
								.requestInit)];
						case 1:
							if (!(e = o.sent()).ok) throw new Error(
								"Request to ".concat(this.path,
						...
						case 4:
							throw o.sent(), n =
								...
								.concat(this.path, "."), this.path.endsWith(
									".pb") ? n +=
								...
								new Error(n);
						case 5:
							if (r = t.modelTopology, a = t.weightsManifest,
								null == r && null == a) throw new Error(
			...
			return a(this, void 0, void 0, (function() {
				...
				return o(this, (function(t) {
					switch (t.label) {
						case 0:
							return this.loadOptions.streamWeights ? [2, this
								.loadStream()
							] : [4, this.loadModelJSON()];
						case 1:
							return [2, Ha(t.sent(), (function(t) {
			...
			return a(this, void 0, void 0, (function() {
				...
				return o(this, (function(s) {
					switch (s.label) {
						...
						case 1:
							return e = s.sent(), [4, this.getWeightUrls(e
								.weightsManifest)];
						case 2:
							return t = s.sent(), n = Ja(e.weightsManifest),
								r =
								function() {
									return function(e, t) {
										var n, r, i = this,
											s = null == t.fetchFunc ?
											TTWebAssembly.fetch : t
											.fetchFunc,
											u = 0;
										return null === (n = t
												.onProgress) ||
								...
								}, [2, Object.assign(Object.assign({}, e), {
									weightSpecs: n,
									getWeightStream: r
								})]
					}
			...
			return a(this, void 0, void 0, (function() {
				...
				return o(this, (function(o) {
					switch (o.label) {
						case 0:
							t = Array.isArray(this.path) ? this.path[1] :
								this
								.path, n = s(function(e) {
									var t = e.lastIndexOf("/"),
										n = e.lastIndexOf("?"),
										...
										a = n > t ? e.substring(n) : "";
									return [r + "/", a]
								}(t), 2), r = n[0], a = n[1], c = this
								.weightPathPrefix || r, l = [], h = [];
							try {
								for (f = i(e), d = f.next(); !d.done; d = f
									.next()) {
									p = d.value;
									try {
										for (S = void 0, g = i(p.paths), v =
											g
											.next(); !v.done; v = g.next())
											m =
											v.value, null != this
											.weightUrlConverter ? h.push(
												this
												.weightUrlConverter(m)) : l
											.push(c + m + a)
									} catch (e) {
										S = {
											error: e
								...
								try {
									d && !d.done && (E = f.return) && E
										.call(f)
								} finally {
									if (x) throw x.error
								}
							}
							return this.weightUrlConverter ? (b = (y = l
									.push)
								.apply, w = [l], k = [
									[]
								], [4, Promise.all(h)]) : [3, 2];
						case 1:
							b.apply(y, w.concat([u.apply(void 0, k.concat([s
								.apply(void 0, [o
									.sent()
								]), !1
							]))])), o.label = 2;
			...
			return a(this, void 0, void 0, (function() {
				...
				return o(this, (function(a) {
					switch (a.label) {
						...
						case 1:
							return t = a.sent(), n = Ja(e), [4, Kh(t, this
								.loadOptions)];
						case 2:
	...
	var Yh = function() {
		...
		Qh = function(e) {
			e.load && (this.load = function() {
				return Promise.resolve(e.load())
			}), e.save && (this.save = function(t) {
	...
	function $h(e, t, n, r) {
		if (1 === arguments.length) {
			...
			return a ? new Yh(e) : (console.warn(
	...
	var ef = {
		...
		decodeWeightsStream: function(e, t) {
			return a(this, void 0, void 0, (function() {
				var n, r, s, u, c, l, h, f, d, p, g, v, m, b = this;
				return o(this, (function(w) {
					switch (w.label) {
						case 0:
							n = {}, r = e.getReader(), s = new ArrayBuffer(
									0), w
								.label = 1;
						case 1:
							w.trys.push([1, 7, 8, 9]), u = i(t), c = u
								.next(), w
								.label = 2;
						case 2:
							return c.done ? [3, 6] : [4, Oa(l = c.value, (
								function(e, t) {
									return a(b, void 0, void 0,
										(
											function() {
												return o(
													this,
						...
						case 4:
							s = w.sent(), f = s.slice(0, h), s = s.slice(h),
								d =
								La(l, f), n[l.name] = d, "webgpu" ===
							Ba() &&
								"uploadToGPU" in (p = Fa()) && y(d.shape) >=
								Z()
								.get("WEBGPU_CPU_HANDOFF_SIZE_THRESHOLD") &&
								p
								.uploadToGPU(d.dataId), w.label = 5;
						case 5:
							return c = u.next(), [3, 2];
						case 6:
							return [3, 9];
		...
		encodeWeights: function(e, t) {
			return a(this, void 0, void 0, (function() {
				var n, r, i, s, u, c = this;
				return o(this, (function(l) {
					switch (l.label) {
						case 0:
							for (n = [], r = [], i = Array.isArray(e) ? e
								.map((
									function(e) {
										return e.name
									})) : Object.keys(e), s = function(s) {
									var u = i[s],
										l = Array.isArray(e) ? e[s].tensor :
										e[
											u];
									if ("float32" !== l.dtype && "int32" !==
										l
										.dtype && "bool" !== l.dtype &&
										"string" !== l.dtype &&
										"complex64" !==
										l.dtype) throw new Error(
			...
			return a(this, void 0, void 0, (function() {
				...
				return o(this, (function(o) {
					switch (o.label) {
						...
						case 1:
							o.trys.push([1, 6, 7, 8]), n = i(e), r = n
								.next(), o
								.label = 2;
						case 2:
							return r.done ? [3, 5] : (a = r.value, [4, bo
								.getManager(a).listModels()
							]);
						case 3:
		...
		removeModel: function(e) {
			return a(this, void 0, void 0, (function() {
				var t;
				return o(this, (function(n) {
					return t = wo(e), [2, bo.getManager(t.scheme)
						.removeModel(t
							.path)
					]
				}))
			...
			confusionMatrix: Sa({
				confusionMatrix_: function(e, t, n) {
					...
					g(null == n || n > 0 && Number.isInteger(n), (function() {
						...
						return "Expected the rank of labels to be 1, but got "
							.concat(r
								.rank)
					})), g(1 === a.rank, (function() {
						...
						return "Mismatch in the number of examples: " + "".concat(r
								.shape[0], " vs. ").concat(a.shape[0], ". ") +
	...
	function af(e, t) {
		if (void 0 === t && (t = 3), t > 4) throw new Error(
		...
		if (e.data instanceof Uint8Array) n = !0;
			...
			if (!("undefined" != typeof ImageBitmap && e instanceof ImageBitmap)) throw new Error(
		...
		var h, f, d = s(a ? [e.videoWidth, e.videoHeight] : [e.width, e.height], 2),
			p = d[0],
			g = d[1];
		if (i) h = e.getContext("2d").getImageData(0, 0, p, g).data;
			...
			if (null == tf)
				if ("undefined" == typeof document) {
					if ("undefined" == typeof OffscreenCanvas || "undefined" ==
						typeof OffscreenCanvasRenderingContext2D) throw new Error(
				...
				} else tf = document.createElement("canvas").getContext("2d", {
					willReadFrequently: !0
				});
			tf.canvas.width = p, tf.canvas.height = g, tf.drawImage(e, 0, 0, p, g), h = tf.getImageData(0,
				0, p,
				g).data
		}
	...
	function of(e) {
		return "undefined" != typeof window && "undefined" != typeof ImageBitmap && window.hasOwnProperty(
			"createImageBitmap") && !(e instanceof ImageBitmap) && function(e) {
	...
	function sf(e) {
		if (2 !== e.rank && 3 !== e.rank) throw new Error(
			"toPixels only supports rank 2 or 3 tensors, got rank ".concat(e.rank, "."));
		var t = 2 === e.rank ? 1 : e.shape[2];
		if (t > 4 || 2 === t) throw new Error("toPixels only supports depth of size " + "1, 3 or 4 but got "
			.concat(t));
		if ("float32" !== e.dtype && "int32" !== e.dtype) throw new Error("Unsupported type for toPixels: "
			.concat(e.dtype, ".") + " Please use float32 or int32 tensors.")
	}
	var uf = {
		__proto__: null,
		draw: function(e, t, n) {
			...
			sf(r),
				function(e) {
					...
					if (t > 1 || t < 0) throw new Error("Alpha value ".concat(t,
						" is suppoed to be in range [0 - 1]."))
		...
		fromPixelsAsync: function(e, t) {
			return void 0 === t && (t = 3), a(this, void 0, void 0, (function() {
				var n, r;
				return o(this, (function(a) {
					switch (a.label) {
						case 0:
						...
						case 4:
							return n = null != r && r.width === e.width && r
								.height === e.height ? r : e, [3, 6];
						case 5:
							n = e, a.label = 6;
						case 6:
							return [2, af(n, t)]
		...
		toPixels: function(e, t) {
			return a(this, void 0, void 0, (function() {
				...
				return o(this, (function(o) {
					switch (o.label) {
						case 0:
							return n = ka(e, "img", "toPixels"),
								e instanceof Vr || (n = Io(r = n, "int32"),
									r
									.dispose()), sf(n), a = s(n.shape.slice(
									0,
									2), 2), i = a[0], u = a[1], c = 2 === n
								.rank ? 1 : n.shape[2], [4, n.data()];
						case 1:
							for (l = o.sent(), h = "float32" === n.dtype ?
								255 :
								1, f = new Uint8ClampedArray(u * i * 4), d =
								0; d < i * u; ++d) {
								for (p = [0, 0, 0, 255], g = 0; g <
									c; g++) {
									if (v = l[d * c + g], "float32" === n
										.dtype) {
										if (v < 0 || v > 1) throw new Error(
											"Tensor values for a float32 Tensor must be in the " +
											"range [0 - 1] but encountered "
											.concat(v, "."))
									} else if ("int32" === n.dtype && (v <
											0 ||
											v > 255)) throw new Error(
										"Tensor values for a int32 Tensor must be in the " +
										"range [0 - 255] but encountered "
										.concat(v, "."));
									1 === c ? (p[0] = v * h, p[1] = v * h,
										p[
											2] = v * h) : p[g] = v * h
								}
								f[(m = 4 * d) + 0] = Math.round(p[0]), f[m +
										1] = Math.round(p[1]), f[m + 2] =
									Math
									.round(p[2]), f[m + 3] = Math.round(p[
										3])
							}
							return null != t && (rf || null != Pn(Le, da
										.backendName) && (console.warn(
										"tf.browser.toPixels is not efficient to draw tensor on canvas. Please try tf.browser.draw instead."
									), rf = !0), t.width = u, t.height = i,
									y = t.getContext("2d"), b =
									new ImageData(f,
										u, i), y.putImageData(b, 0, 0)),
								n !==
								e && n.dispose(), [2, f]
					}
				}))
	...
	function cf(e, t) {
		var n = e.shape.length,
			r = t.shape.length;
		if (n < 1) throw new Error("tf.gatherND() expects the input to be rank 1 or higher," +
			" but the rank was ".concat(n, "."));
		if (r < 1) throw new Error("tf.gatherND() expects the indices to be rank 1 or higher," +
			" but the rank was ".concat(r, "."));
		if ("int32" !== t.dtype) throw new Error("tf.gatherND() expects the indices to be int32 type," +
			" but the dtype was ".concat(t.dtype, "."));
		if (t.shape[r - 1] > n) throw new Error(
			"index innermost dimension length must be <= tensor rank; saw: " + "".concat(t.shape[r -
					1],
				" vs. ").concat(n));
		if (0 === y(e.shape)) throw new Error("Requested more than 0 entries, but input is empty." +
			" Input shape: ".concat(e.shape, "."));
		for (var a = t.shape, o = a[a.length - 1], i = 1, c = 0; c < a.length - 1; ++c) i *= a[c];
		var l = e.shape,
			h = a.slice();
		h.pop();
		var f = 1;
		for (c = o; c < n; ++c) f *= l[c], h.push(l[c]);
		var d = u(u([], s(O(e.shape).map((function(e) {
			return e / f
		}))), !1), [1], !1).slice(0, o);
		return [h, i, f, d]
	}
	...
	function mf(e, t, n, r, a, o) {
		var i = t[a],
			s = n[a] || 1;
		(e & 1 << a || o & 1 << a || null == i) && (i = s > 0 ? Number.MIN_SAFE_INTEGER : Number
			.MAX_SAFE_INTEGER);
		var u = r[a];
	...
	function yf(e, t, n, r, a, o) {
		var i = t[a],
			s = n[a] || 1;
		(e & 1 << a || o & 1 << a || null == i) && (i = s > 0 ? Number.MAX_SAFE_INTEGER : Number
			.MIN_SAFE_INTEGER);
		var u = r[a];
	...
	var wf, kf = {
			...
			assertParamsValid: function(e, t, n) {
				...
				g(r === t.length, (function() {
					return "Error in slice".concat(r, "D: Length of begin ").concat(t,
						" must ") + "match the rank of the array (".concat(r, ").")
				})), g(r === n.length, (function() {
					return "Error in slice".concat(r, "D: Length of size ").concat(n,
						" must ") + "match the rank of the array (".concat(r, ").")
				}));
				for (var a = function(a) {
						g(t[a] + n[a] <= e.shape[a], (function() {
							return "Error in slice".concat(r, "D: begin[").concat(a,
									"] + size[").concat(a, "] ") + "(".concat(t[a] + n[
										a],
									") would overflow input.shape[").concat(a, "] (")
								.concat(e.shape[a], ")")
						}))
					}, o = 0; o < r; ++o) a(o)
			},
			computeFlatOffset: function(e, t) {
				for (var n = e.length > 0 ? e[e.length - 1] : 1, r = 0; r < e.length - 1; r++) n += e[
					r] *
					t[r];
				return n
			},
			...
			getNormalizedAxes: function(e, t, n, r, a, o, i, s, u) {
				...
				if (t.length && n > 0) {
					var d = t[0],
						p = n + 1;
					l = pf(i, d, p, r, e), h = gf(s, d, p, a, e), f = hf(o, d, p, e)
				} else
					for (var g = 0; g < c; g++) l[g] = mf(i, r, o, e, g, u), h[g] = yf(s, a, o, e, g,
						u), f[
							g] = vf(o, g, u);
				return {
					begin: l,
			...
			parseSliceParams: function(e, t, n) {
				...
				return (r = "number" == typeof t ? u([t], s(new Array(o - 1).fill(0)), !1) : t.length <
					o ?
					t.concat(new Array(o - t.length).fill(0)) : t.slice()).forEach((function(e) {
					g(-1 !== e, (function() {
						return "slice() does not support negative begin indexing."
					}))
				})), a = (a = null == n ? new Array(o).fill(-1) : "number" == typeof n ? u([n], s(
					new Array(o - 1).fill(-1)), !1) : n.length < o ? n.concat(new Array(o - n
					.length).fill(-1)) : n).map((function(t, n) {
			...
			sliceInfo: function(e, t, n, r, a, o, i, s, u) {
				var c;
				if (null == r ? (c = new Array(t.length)).fill(1) : c = r, null != i && 0 != (i & i -
					1))
				...
				for (var l = !1, h = {
						...
						newAxisMask: s,
						shrinkAxisMask: u
					}, f = 0; f < h.dims; f++) l && 0 != (1 << f & s) && h.numAddAxisAfterEllipsis++,
					1 <<
					f & i && (l = !0);
				...
				! function(e, t) {
					...
					var n = 0;
					t.beginValid = null != e.begin, t.endValid = null != e.end, t.begin = new Array(t
							.dims),
						t.end = new Array(t.dims), t.strides = new Array(t.dims), t
						.finalShapeGatherIndices = [], t.finalShapeGatherIndicesSparse = [], t
						.inputShapeGatherIndicesSparse = new Array(t.dims);
					for (var r = 0; r < e.dims; r++)
						if (1 << r & e.ellipsisMask)
							for (var a = Math.min(t.dims - (e.dims - r) + 1 + e.numAddAxisAfterEllipsis,
									t
									.dims); n < a; n++) t.begin[n] = 0, t.end[n] = 0, t.strides[n] = 1,
								t
								.beginMask |= 1 << n, t.endMask |= 1 << n, t.finalShapeGatherIndices
								.push(
									n), t.finalShapeGatherIndicesSparse.push(-1), t
								.inputShapeGatherIndicesSparse[n] = r;
						else if (1 << r & e.newAxisMask) t.finalShapeGatherIndices.push(-2), t
						.finalShapeGatherIndicesSparse.push(-1);
					else {
						if (n === t.begin.length) throw Error("Index out of range using input dim "
							.concat(
								n, "; input ") + "has only ".concat(t.dims, " dims, ").concat(t
								.begin.length, "."));
						null != e.begin && (t.begin[n] = e.begin[r]), null != e.end && (t.end[n] = e
								.end[
									r]), t.strides[n] = e.strides[r], e.beginMask & 1 << r && (t
								.beginMask |= 1 <<
								n), e.endMask & 1 << r && (t.endMask |= 1 << n), e.shrinkAxisMask & 1 <<
							r ?
							(t.finalShapeGatherIndices.push(-1), t.finalShapeGatherIndicesSparse.push(-
									1), t
								.shrinkAxisMask |= 1 << n) : (t.finalShapeGatherIndices.push(n), t
								.finalShapeGatherIndicesSparse.push(r)), t
					...
					if (-1 !== w) {
						...
						if (d.beginValid && d.endValid) {
							if (b) {
								...
								if (d.begin[f] = S, d.end[f] = d.begin[f] + 1, S < 0 || S >= w)
								throw Error(
										"slice index ".concat(d.begin[f], " of dimension ").concat(
											f,
											" out of bounds."))
							} else d.begin[f] = bf(d.begin[f], 0, d.strides[f], w, k, x), d.end[f] = bf(
								d
								.end[f], 1, d.strides[f], w, k, x);
							var A = 1 === d.strides[f] && 0 === d.begin[f] && d.end[f] === w;
							p = p && A, g = g && (0 === f && 1 === d.strides[f] || A)
						} else p = p && 1 === d.strides[f] && E, g = g && (0 === f && 1 === d.strides[
							f] ||
							E);
						var _ = void 0,
							I = !1;
						if (d.beginValid && d.endValid ? (_ = d.end[f] - d.begin[f], I = !0) : b ? (_ =
								1,
								I = !0) : E && w >= 0 && (_ = d.strides[f] < 0 ? -w : w, I = !0), I) {
							var N = void 0;
							N = 0 === _ || _ < 0 != d.strides[f] < 0 ? 0 : Math.trunc(_ / d.strides[
								f]) + (
									_ % d.strides[f] != 0 ? 1 : 0), m.push(N)
						} else m.push(-1)
					} else m.push(b ? 1 : -1)
				}
		...
		xf = function() {
			...
			return e.sgd = function(e) {
				...
				return void 0 === t && (t = .9), void 0 === n && (n = 0), void 0 === r && (r = null),
					void 0 === a && (a = !1), new Lh(e, t, n, r, a)
			}, e.adam = function(e, t, n, r) {
				return void 0 === e && (e = .001), void 0 === t && (t = .9), void 0 === n && (n = .999),
					void 0 === r && (r = null), new Fh(e, t, n, r)
			}, e.adadelta = function(e, t, n) {
				return void 0 === e && (e = .001), void 0 === t && (t = .95), void 0 === n && (n =
					null),
					new Rh(e, t, n)
			}, e.adamax = function(e, t, n, r, a) {
				return void 0 === e && (e = .002), void 0 === t && (t = .9), void 0 === n && (n = .999),
					void 0 === r && (r = null), void 0 === a && (a = 0), new Ch(e, t, n, r, a)
			}, e.adagrad = function(e, t) {
				return void 0 === t && (t = .1), new Bh(e, t)
			}, e
		}(),
		Ef = xf,
		Sf = "undefined" != typeof requestAnimationFrame ? requestAnimationFrame : "undefined" !=
		typeof setImmediate ? setImmediate : function(e) {
			return e()
		};
	! function(e) {
		e[e.FIRST_DIM_SIZE = 0] = "FIRST_DIM_SIZE", e[e.VALUE_ROWIDS = 1] = "VALUE_ROWIDS", e[e
				.ROW_LENGTHS =
				2] = "ROW_LENGTHS", e[e.ROW_SPLITS = 3] = "ROW_SPLITS", e[e.ROW_LIMITS = 4] = "ROW_LIMITS",
			e[e
	...
	function If(e, t) {
		for (var n = [], r = 0; r < e.length; ++r) 0 !== e[r].length && -1 === e[r].indexOf(t) && -1 !==
			t || n
			.push(r);
		return n
	}
	var Nf = {
			...
			assertAxesAreInnerMostDims: function(e, t, n) {
				g(is(t, n), (function() {
					return "".concat(e, " supports only inner-most axes for now. ") +
			...
			assertParamsConsistent: function(e, t) {
				...
				e.forEach((function(e, t) {
					g(e.length === n, (function() {
						return "Error in concat".concat(n,
								"D: rank of tensors[")
							.concat(t, "] must be the same ") +
							"as the rank of the rest (".concat(n, ")")
					}))
				})), g(t >= 0 && t < n, (function() {
					return "Error in concat".concat(n, "D: axis must be between 0 and ")
						.concat(
							n - 1, ".")
				}));
				var r = e[0];
				e.forEach((function(e, a) {
					for (var o = 0; o < n; o++) g(o === t || e[o] === r[o], (function() {
						return "Error in concat".concat(n,
								"D: Shape of tensors[")
							.concat(a, "] (").concat(e, ") ") +
			...
			checkEinsumDimSizes: function(e, t, n) {
				for (var r = new Array(e), a = function(e) {
						for (var a = n[e].shape, o = function(n) {
								void 0 === r[t[e][n]] ? r[t[e][n]] = a[n] : g(r[t[e][n]] === a[
									n], (
									function() {
										return "Expected dimension ".concat(r[t[e][n]],
												" at axis ").concat(n, " ") +
											"of input shaped ".concat(JSON.stringify(a),
												", ") + "but got dimension ".concat(a[
												n])
									}))
							}, i = 0; i < t[e].length; ++i) o(i)
			...
			combineRaggedTensorToTensorShapes: function(e, t, n) {
				...
				if (null == n) return r;
				if (e + n.length !== r.length) throw new Error("rt input.shape and shape=".concat(t,
					" are incompatible: rt input.rank = ").concat(e + n.length,
					", but shape.rank = ").concat(r.length));
				for (var a = 1; a < n.length; ++a) {
					...
					if (o >= 0)
						if (s >= 0) {
							if (s !== o) throw new Error("rt input.shape and shape=".concat(t,
									" are incompatible: rt input.shape[").concat(a + e, "] = ")
								.concat(o, " but shape[").concat(a + e, "] = ").concat(s))
						} else r[i] = o
				}
				return r
			},
			complexWithEvenIndex: function(e) {
				for (var t = Math.ceil(e.length / 4), n = new Float32Array(t), r = new Float32Array(t),
						a =
						0; a < e.length; a += 4) n[Math.floor(a / 4)] = e[a], r[Math.floor(a / 4)] = e[
					a +
					1];
				return {
					real: n,
			...
			complexWithOddIndex: function(e) {
				for (var t = Math.floor(e.length / 4), n = new Float32Array(t), r = new Float32Array(t),
						a =
						2; a < e.length; a += 4) n[Math.floor(a / 4)] = e[a], r[Math.floor(a / 4)] = e[
					a +
					1];
				return {
					real: n,
			...
			decodeEinsumEquation: function(e, t) {
				var n = ((e = e.replace(/\s/g, "")).length - e.replace(_f, "").length) / Af.length;
				if (n < 1) throw new Error("Equations without an arrow are not supported.");
				if (n > 1) throw new Error('Equation must contain exactly one arrow ("'.concat(Af,
					'").'));
				...
				var i = a.split(","),
					u = i.length;
				if (t !== u) throw new Error("Expected ".concat(u, " input tensors, received ").concat(
					t));
				if (u > 2) throw new Error(
					"Support for more than 2 input tensors is not implemented yet.");
				for (var c = [], l = function(e) {
						var t = o[e];
						if (!i.some((function(e) {
								return -1 !== e.indexOf(t)
							}))) throw new Error("Output subscripts contain the label ".concat(t,
								" ") +
							"not present in the input subscripts."); - 1 === c.indexOf(t) && c.push(
							t)
					}, h = 0; h < o.length; ++h) l(h);
				for (h = 0; h < a.length; ++h) {
					var f = a[h]; - 1 === c.indexOf(f) && "," !== f && c.push(f)
				}
				var d = new Array(i.length);
				for (h = 0; h < u; ++h) {
					if (new Set(i[h].split("")).size !== i[h].length) throw new Error(
			...
			exponents: function(e, t) {
				for (var n = new Float32Array(e / 2), r = new Float32Array(e / 2), a = 0; a < Math.ceil(
						e /
						2); a++) {
			...
			fromUint8ToStringArray: function(e) {
				try {
					...
					throw new Error("Failed to decode encoded string bytes into utf-8, error: ".concat(
						e))
				}
			},
			...
			getEinsumComputePath: function(e, t) {
				...
				for (u = 0; u < o.length; ++u) {
					var l = If(t, o[u]);
					try {
						for (var h = (n = void 0, i(l)), f = h.next(); !f.done; f = h.next()) {
							var d = f.value; - 1 === c.indexOf(d) && (s[u].push(d), c.push(d))
						}
					} catch (e) {
						n = {
							error: e
			...
			getPermuted: function(e, t, n) {
				...
				if (n) {
					r.push(t);
					for (var a = t + 1; a < e; ++a) a <= 2 * t ? (r.push(a), r.push(a - (t + 1))) : r
						.push(
							a)
				} else {
					var o = [],
						i = [];
					for (a = 1; a < e; ++a) a >= 2 * t + 1 || a % 2 == 1 ? i.push(a) : o.push(a);
					r.push.apply(r, u([], s(o), !1)), r.push(0), r.push.apply(r, u([], s(i), !1))
				}
				return r
			},
			getRaggedRank: function(e) {
				return 0 === e.length ? 0 : e[0] === wf.FIRST_DIM_SIZE ? e.length - 1 : e.length
			},
			getReductionAxes: Ji,
			getReshaped: function(e, t, n, r) {
				...
				if (r)(a = a.concat(t.slice(0))).push(e[0] / n), a = a.concat(e.slice(1));
					...
					a = a.concat(e[0]);
					for (var o = t.length, i = 0; i < o; ++i) a = a.concat([e[i + 1] / t[i], t[i]]);
			...
			getReshapedPermuted: function(e, t, n, r) {
				...
				for (var o = 1; o < e.length; ++o) o <= t.length ? r ? a.push(t[o - 1] * e[o]) : a.push(
					e[
						o] / t[o - 1]) : a.push(e[o]);
				return a
			},
			...
			getSparseReshapeInputOutputMismatchErrorMessage: function(e, t) {
				var n = y(e),
					r = y(t);
				return "Input to reshape is a tensor with ".concat(n,
						" dense values, but the requested shape has ").concat(r, ". inputShape=")
					.concat(e,
						" outputShape=").concat(t)
			},
			getSparseReshapeInputOutputMultipleErrorMessage: function(e, t) {
				var n = y(e),
					r = y(t);
				return "Input to reshape is a SparseTensor with ".concat(n,
					"\n  dense values, but the requested shape requires a multiple of ").concat(r,
					". inputShape=").concat(e, " outputShape= ").concat(t)
			},
			...
			getSparseSegmentReductionSegmentIdOutOfRangeErrorMessage: function(e, t) {
				return "Segment id ".concat(e, " out of range [0, ").concat(t,
					"), possibly because segmentIds input is not sorted.")
			},
			...
			log: function() {
				for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
				Z().getBool("IS_TEST") || Z().getBool("PROD") || console.log.apply(console, u([], s(e),
					!1))
			},
			mergeRealAndImagArrays: function(e, t) {
				if (e.length !== t.length) throw new Error(
					"Cannot merge real and imag arrays of different lengths. real:" + "".concat(
						e
						.length, ", imag: ").concat(t.length, "."));
				for (var n = new Float32Array(2 * e.length), r = 0; r < n.length; r += 2) n[r] = e[r /
						2],
					n[r + 1] = t[r / 2];
				return n
			},
			...
			prepareSplitSize: function(e, t, n) {
				void 0 === n && (n = 0);
				var r = [];
				if ("number" == typeof t) g(e.shape[n] % t == 0, (function() {
					...
					g(e.shape[n] === t.reduce((function(e, t) {
						return e + t
					})), (function() {
			...
			segment_util: {
				...
				collectGatherOpShapeInfo: function(e, t, n, r) {
					var a = t.shape.length,
						o = e.shape.length;
					if (0 !== r && (r < -a || r > a)) throw new Error(
						"Expect batchDims in the range of [-"
						.concat(a, ", ").concat(a, "], but got ").concat(r));
					if (r < 0 && (r += a), r > o) throw new Error("batchDims (".concat(r,
						") must be less than rank(x) (\n    ").concat(o, ")."));
					if (n < r) throw new Error("batchDims (".concat(r,
						") must be less than or equal to axis (").concat(n, ")."));
					for (var i = 0; i < r; ++i)
						if (e.shape[i] !== t.shape[i]) throw new Error("x.shape[".concat(i, "]: ")
							.concat(e
								.shape[i], " should be equal to indices.shape[").concat(i,
								"]: ")
							.concat(t.shape[i], "."));
					var s = e.shape[n],
						u = [],
				...
				computeOutShape: function(e, t, n) {
					for (var r = [], a = e.length, o = 0; o < a; o++) o !== t ? r.push(e[o]) : r.push(
					n);
					return r
				},
				segOpComputeOptimalWindowSize: function(e, t) {
					var n, r = !1;
					for (e <= 30 ? (n = e, r = !0) : n = P(e, Math.floor(Math.sqrt(e))); !r;) n > t ||
						n ===
						e ? r = !0 : n = P(e, n + 1);
					return n
				}
			...
			splitRealAndImagArrays: function(e) {
				for (var t = new Float32Array(e.length / 2), n = new Float32Array(e.length / 2), r =
					0; r <
					e.length; r += 2) t[r / 2] = e[r], n[r / 2] = e[r + 1];
				return {
					real: t,
					imag: n
				}
			...
			validateDefaultValueShape: function(e, t) {
				if (null != e && null != t) {
					var n = e.length,
						r = t.length;
					if (n >= r) throw new Error("defaultValue.shape=".concat(e,
						" and ragged tensor flatValues.shape=").concat(t,
						", are incompatible: defaultValue.rank = ").concat(n,
						" must be less than ragged tensor input flatValues.rank = ").concat(
						r,
						")"));
					for (var a = 0; a < Math.min(n, r - 1); ++a) {
						var o = e[a],
							i = t[a + 1];
						if (o >= 0 && i >= 0 && 1 !== o && o !== i) throw new Error(
							"defaultValue.shape="
							.concat(e, ", and ragged tensor input flatValues.shape=").concat(t,
								" are incompatible: defaultValue.shape[").concat(a - e.length,
								"] = ").concat(o, " but ragged tensor input.flatValues.shape[")
							.concat(a - e.length, "] = ").concat(i))
					}
				}
			},
			validateInput: Hc,
	...
	! function() {
	...
	}(), e.Abs = "Abs", e.Acos = Q, e.Acosh = $, e.AdadeltaOptimizer = Rh, e.AdagradOptimizer = Bh, e
		.AdamOptimizer = Fh, e.AdamaxOptimizer = Ch, e.Add = ee, e.AddN = te, e.All = "All", e.Any = "Any",
		e
		.ArgMax = ne, e.ArgMin = re, e.Asin = ae, e.Asinh = oe, e.Atan = ie, e.Atan2 = ue, e.Atanh = se, e
		.AvgPool = ce, e.AvgPool3D = le, e.AvgPool3DGrad = "AvgPool3DGrad", e.AvgPoolGrad = "AvgPoolGrad", e
		.BatchMatMul = he, e.BatchToSpaceND = fe, e.Bincount = de, e.BitwiseAnd = pe, e.BroadcastArgs = ge,
		e
		.BroadcastTo = "BroadcastTo", e.Cast = ve, e.Ceil = me, e.ClipByValue = ye, e.Complex = be, e
		.ComplexAbs = we, e.Concat = ke, e.Conv2D = xe, e.Conv2DBackpropFilter = Ee, e.Conv2DBackpropInput =
		Se,
		e.Conv3D = Ae, e.Conv3DBackpropFilterV2 = "Conv3DBackpropFilterV2", e.Conv3DBackpropInputV2 = _e, e
		.Cos = "Cos", e.Cosh = Ie, e.CropAndResize = Te, e.Cumprod = Ne, e.Cumsum = Me, e.DataStorage = c, e
		.DenseBincount = De, e.DepthToSpace = Re, e.DepthwiseConv2dNative = Be, e
		.DepthwiseConv2dNativeBackpropFilter = Fe, e.DepthwiseConv2dNativeBackpropInput = Ce, e.Diag = Pe, e
		.Dilation2D = Oe, e.Dilation2DBackpropFilter = "Dilation2DBackpropFilter", e
		.Dilation2DBackpropInput =
		"Dilation2DBackpropInput", e.Draw = Le, e.Einsum = Ue, e.Elu = "Elu", e.EluGrad = "EluGrad", e
		.Environment = H, e.Equal = We, e.Erf = "Erf", e.Exp = "Exp", e.ExpandDims = Ge, e.Expm1 = qe, e
		.FFT =
		"FFT", e.Fill = Ke, e.FlipLeftRight = Ve, e.Floor = He, e.FloorDiv = je, e.FromPixels = Nn, e
		.FusedBatchNorm = Je, e.FusedConv2D = Dn, e.FusedDepthwiseConv2D = Rn, e.GatherNd = Ye, e.GatherV2 =
		Ze,
		e.Greater = Xe, e.GreaterEqual = Qe, e.IFFT = et, e.Identity = $e, e.Imag = tt, e.IsFinite = nt, e
		.IsInf = rt, e.IsNan = at, e.KernelBackend = l, e.LRN = "LRN", e.LRNGrad = "LRNGrad", e.LeakyRelu =
		ot,
		e.Less = it, e.LessEqual = st, e.LinSpace = ut, e.Log = "Log", e.Log1p = ct, e.LogSoftmax =
		"LogSoftmax", e.LogicalAnd = lt, e.LogicalNot = ht, e.LogicalOr = ft, e.LogicalXor = "LogicalXor", e
		.LowerBound = "LowerBound", e.MatrixBandPart = "MatrixBandPart", e.Max = "Max", e.MaxPool = pt, e
		.MaxPool3D = gt, e.MaxPool3DGrad = "MaxPool3DGrad", e.MaxPoolGrad = "MaxPoolGrad", e
		.MaxPoolWithArgmax =
		vt, e.Maximum = dt, e.Mean = mt, e.Min = "Min", e.Minimum = yt, e.MirrorPad = bt, e.Mod = "Mod", e
		.MomentumOptimizer = Oh, e.Multinomial = wt, e.Multiply = kt, e.Neg = "Neg", e.NonMaxSuppressionV3 =
		Et,
		e.NonMaxSuppressionV4 = St, e.NonMaxSuppressionV5 = At, e.NotEqual = xt, e.OP_SCOPE_SUFFIX = Ea, e
		.OneHot = It, e.OnesLike = _t, e.Optimizer = Dh, e.OptimizerConstructors = xf, e.Pack = Nt, e
		.PadV2 =
		Mt, e.Pool = "Pool", e.Pow = "Pow", e.Prelu = Tt, e.Prod = Dt, e.RMSPropOptimizer = Lh, e
		.RaggedGather =
		Rt, e.RaggedRange = Bt, e.RaggedTensorToTensor = Ft, e.Range = Ct, e.Real = Pt, e.RealDiv = ze, e
		.Reciprocal = Ot, e.Relu = Lt, e.Relu6 = Gt, e.Reshape = zt, e.ResizeBilinear = Wt, e
		.ResizeBilinearGrad = "ResizeBilinearGrad", e.ResizeNearestNeighbor = Ut, e
		.ResizeNearestNeighborGrad =
		"ResizeNearestNeighborGrad", e.Reverse = qt, e.RotateWithOffset = Mn, e.Round = Kt, e.Rsqrt = Vt, e
		.SGDOptimizer = Ph, e.ScatterNd = Ht, e.SearchSorted = Jt, e.Select = Zt, e.Selu = Yt, e.Sigmoid =
		en, e
		.Sign = $t, e.Sin = "Sin", e.Sinh = Qt, e.Slice = Xt, e.Softmax = on, e.Softplus = tn, e
		.SpaceToBatchND = rn, e.SparseFillEmptyRows = sn, e.SparseReshape = un, e.SparseSegmentMean = cn, e
		.SparseSegmentSum = ln, e.SparseToDense = hn, e.SplitV = an, e.Sqrt = nn, e.Square = "Square", e
		.SquaredDifference = fn, e.StaticRegexReplace = dn, e.Step = In, e.StridedSlice = pn, e
		.StringNGrams =
		gn, e.StringSplit = vn, e.StringToHashBucketFast = mn, e.Sub = "Sub", e.Sum = "Sum", e.Tan = "Tan",
		e
		.Tanh = yn, e.Tensor = Vr, e.TensorBuffer = Gr, e.TensorScatterUpdate = jt, e.Tile = bn, e.TopK =
		wn, e
		.Transform = kn, e.Transpose = xn, e.Unique = En, e.Unpack = Sn, e.UnsortedSegmentSum = An, e
		.UpperBound = "UpperBound", e.Variable = Qr, e.ZerosLike = _n, e._FusedMatMul = Tn, e.abs = Fo, e
		.acos =
		Co, e.acosh = Po, e.add = To, e.addN = Oo, e.all = Lo, e.any = zo, e.argMax = Uo, e.argMin = Wo, e
		.asin = Go, e.asinh = qo, e.atan = Ko, e.atan2 = Vo, e.atanh = Ho, e.avgPool = si, e.avgPool3d = ui,
		e
		.backend = Fa, e.backend_util = Nf, e.basicLSTMCell = pi, e.batchNorm = vi, e.batchNorm2d = mi, e
		.batchNorm3d = yi, e.batchNorm4d = bi, e.batchToSpaceND = gi, e.bincount = wi, e.bitwiseAnd = ki, e
		.booleanMaskAsync = rl, e.broadcastArgs = xi, e.broadcastTo = Ei, e.broadcast_util = Yi, e.browser =
		uf,
		e.buffer = _o, e.cast = Io, e.ceil = Si, e.clipByValue = _i, e.clone = No, e.complex = Aa, e
		.concat =
		ci, e.concat1d = Ii, e.concat2d = Ni, e.concat3d = Mi, e.concat4d = Ti, e.conv1d = Ri, e.conv2d =
		Di, e
		.conv2dTranspose = Fi, e.conv3d = Ci, e.conv3dTranspose = Oi, e.copyRegisteredKernels = function(e,
			t) {
		...
		}, e.cos = Li, e.cosh = zi, e.cosineWindow = hl, e.cumprod = Ui, e.cumsum = Wi, e.customGrad = zs, e
		.denseBincount = Gi, e.deprecationWarn = function(e) {
			Z().getBool("DEPRECATION_WARNINGS_ENABLED") && console.warn(e +
				" You can disable deprecation warnings with tf.disableDeprecationWarnings().")
		}, e.depthToSpace = qi, e.depthwiseConv2d = Ki, e.device_util = va, e.diag = Vi, e.dilation2d = Hi,
		e
		.disableDeprecationWarnings = function() {
			Z().set("DEPRECATION_WARNINGS_ENABLED", !1), console.warn(
				"TensorFlow.js deprecation warnings have been disabled.")
		}, e.dispose = Da, e.disposeVariables = function() {
			da.disposeVariables()
		}, e.div = Ro, e.divNoNan = es, e.dot = ts, e.dropout = cl, e.einsum = ns, e.elu = rs, e
		.enableDebugMode = function() {
			Z().set("DEBUG", !0)
		}, e.enableProdMode = function() {
			Z().set("PROD", !0)
		}, e.enclosingPowerOfTwo = ll, e.engine = function() {
			return da
		}, e.ensureShape = as, e.env = Z, e.equal = Xi, e.erf = os, e.euclideanNorm = ys, e.exp = bs, e
		.expandDims = ws, e.expm1 = ks, e.eye = Es, e.fft = Dc, e.fill = Ai, e.findBackend = function(e) {
			return da.findBackend(e)
		}, e.findBackendFactory = function(e) {
			return da.findBackendFactory(e)
		}, e.floor = Ss, e.floorDiv = Do, e.fused = El, e.gather = As, e.gatherND = ul, e.gather_util = lf,
		e
		.getBackend = Ba, e.getGradient = On, e.getKernel = Pn, e.getKernelsForBackend = Ln, e.grad =
		function(
			e) {
			return g(C(e), (function() {
				...
				function(t, n) {
					...
					return da.tidy((function() {
						var t = da.gradients((function() {
								return e(r)
							}), [r], a),
							n = t.value,
							o = t.grads;
						return null != a && v(n.shape, a.shape,
		...
		}, e.greater = _s, e.greaterEqual = Is, e.ifft = Rc, e.imag = Ns, e.image = wh, e.inTopKAsync = fl,
		e
		.io = ef, e.irfft = Bc, e.isFinite = Ms, e.isInf = Ts, e.isNaN = Ds, e.keep = Ra, e.kernel_impls =
		Mf, e
		.leakyRelu = Rs, e.less = Bs, e.lessEqual = Fs, e.linalg = kh, e.linspace = function(e, t, n) {
		...
		}, e.localResponseNormalization = Cs, e.log = Ps, e.log1p = Os, e.logSigmoid = qs, e.logSoftmax =
		Vs, e
		.logSumExp = Hs, e.logicalAnd = js, e.logicalNot = Js, e.logicalOr = Zs, e.logicalXor = Ys, e
		.losses =
		xh, e.lowerBound = function(e, t) {
			return Qs(e, t, "left")
		}, e.matMul = li, e.math = nf, e.max = cs, e.maxPool = $s, e.maxPool3d = eu, e.maxPoolWithArgmax =
		tu, e
		.maximum = nu, e.mean = ru, e.memory = function() {
			return da.memory()
			...
			var i = ka(t, "y", "meshgrid", t instanceof Vr ? t.dtype : "float32"),
				s = y(o.shape),
				u = y(i.shape);
			return "xy" === a ? (o = ii(o, [1, -1]), i = ii(i, [-1, 1]), [li(ou([u, 1], o.dtype), o), li(i,
				ou([
					1, s
				], i.dtype))]) : (o = ii(o, [-1, 1]), i = ii(i, [1, -1]), [li(o, ou([1, u], o.dtype)),
				li(ou([s,
					1
				], i.dtype), i)
			])
		}, e.min = ls, e.minimum = iu, e.mirrorPad = su, e.mod = uu, e.moments = cu, e.movingAverage = ol, e
		.mul = Bo, e.multiRNNCell = lu, e.multinomial = hu, e.neg = Ws, e.nextFrame = function() {
			return new Promise((function(e) {
				return Sf((function() {
					return e()
				}))
			}))
		}, e.norm = ms, e.notEqual = fu, e.oneHot = du, e.ones = ou, e.onesLike = pu, e.op = Sa, e
		.outerProduct = gu, e.pad = vu, e.pad1d = mu, e.pad2d = yu, e.pad3d = bu, e.pad4d = wu, e.pool = xu,
		e
		.pow = hs, e.prelu = Eu, e.print = Mo, e.prod = Su, e.profile = function(e) {
			return da.profile(e)
		}, e.raggedGather = Au, e.raggedRange = _u, e.raggedTensorToTensor = Iu, e.rand = Nu, e
		.randomGamma =
		rc, e.randomNormal = ac, e.randomStandardNormal = oc, e.randomUniform = ic, e.randomUniformInt = sc,
		e
		.range = uc, e.ready = function() {
			return da.ready()
		}, e.real = cc, e.reciprocal = lc, e.registerBackend = function(e, t, n) {
			return void 0 === n && (n = 1), da.registerBackend(e, t, n)
		}, e.registerGradient = function(e) {
			var t = e.kernelName;
			Cn.has(t) && Z().getBool("DEBUG") && Bn("Overriding the gradient for '".concat(t, "'")), Cn.set(
				t,
				e)
		}, e.registerKernel = zn, e.relu = hc, e.relu6 = fc, e.removeBackend = function(e) {
			da.removeBackend(e)
		}, e.reshape = ii, e.reverse = dc, e.reverse1d = pc, e.reverse2d = gc, e.reverse3d = vc, e
		.reverse4d =
		mc, e.rfft = Cc, e.round = yc, e.rsqrt = bc, e.scalar = fs, e.scatterND = il, e.scatter_util = Jc, e
		.searchSorted = Qs, e.selu = wc, e.separableConv2d = kc, e.serialization = Th, e.setBackend =
		function(
			e) {
			return da.setBackend(e)
		}, e.setPlatform = function(e, t) {
			Z().setPlatform(e, t)
		}, e.setdiff1dAsync = xc, e.sigmoid = hi, e.sign = Ec, e.signal = bh, e.sin = Sc, e.sinh = Ac, e
		.slice =
		fi, e.slice1d = _c, e.slice2d = Ic, e.slice3d = Nc, e.slice4d = Mc, e.slice_util = kf, e.softmax =
		Tc, e
		.softplus = Gs, e.spaceToBatchND = ku, e.sparse = Eh, e.sparseToDense = sl, e.spectral = yh, e
		.split =
		Fc, e.sqrt = ds, e.square = ps, e.squaredDifference = Pc, e.squeeze = Oc, e.stack = Lc, e.step = zc,
		e
		.stridedSlice = Uc, e.string = Sh, e.sub = Ks, e.sum = gs, e.sumOutType = function(e) {
			return ea(e, "int32")
		}, e.tan = Wc, e.tanh = di, e.tensor = Ia, e.tensor1d = Gc, e.tensor2d = qc, e.tensor3d = Kc, e
		.tensor4d = function(e, t, n) {
			if (m(e), null != t && 4 !== t.length) throw new Error(
			...
			if (m(e), null != t && 5 !== t.length) throw new Error(
			...
			if (m(e), null != t && 6 !== t.length) throw new Error(
		...
		}, e.tensorScatterUpdate = Zc, e.tensor_util = sa, e.test_util = $u, e.tidy = Ta, e.tile = xs, e
		.time =
		function(e) {
			return da.time(e)
		}, e.topk = Yc, e.train = Ef, e.transpose = al, e.truncatedNormal = Xc, e.unique = Qc, e
		.unregisterGradient = function(e) {
			if (!Cn.has(e)) throw new Error("The gradient '".concat(e, "' for backend is not registered"));
			Cn.delete(e)
		}, e.unregisterKernel = function(e, t) {
			var n = Un(e, t);
			if (!Fn.has(n)) throw new Error("The kernel '".concat(e, "' for backend ") + "'".concat(t,
				"' is not registered"));
			Fn.delete(n)
		}, e.unsortedSegmentSum = $c, e.unstack = el, e.upcastType = ea, e.upperBound = function(e, t) {
			return Qs(e, t, "right")
		}, e.util = Fr, e.valueAndGrad = function(e) {
			return g(C(e), (function() {
			...
			return g(C(e), (function() {
				...
				function(t, n) {
					g(Array.isArray(t) && t.every((function(e) {
						return e instanceof Vr
					})), (function() {
					...
					return null != n && v(r.value.shape, n.shape,
		...
		}, e.variableGrads = Ls, e.version_core = "4.22.0", e.where = Qi, e.whereAsync = nl, e.zeros = au, e
		.zerosLike = $i
}));
...
function atobPolyfill(base64) {
    ...
    for (let j = 0; j < base64.length; j++) {
        let charIndex = chars.indexOf(base64.charAt(j));
...
//fetch fix
            ...
            return new Promise(function (resolve, reject) {
                tt.request({
                    ...
                    success: function (resp) { 
                        ...
                        //   console.log(url,new Uint8Array(resp.data))
                        //   var dd=new Uint8Array(resp.data)
                        //   for(var i=0;i<100;i++){
                        //       console.log(dd[i])
                        //   }
    ...
    function setWechatFetch(debug) {
            ...
            debug.fetch = fetchFunc();
        
    }

// 直接在 TTWebAssembly.tf 上一次性设置所需的属性
	Object.assign(TTWebAssembly.tf, {
	  TEXT_FILE_EXTS, // 假设 TEXT_FILE_EXTS 是一个已经定义的变量
	  parseResponse,
	  fetchFunc,
	  setWechatFetch,
	});

    TTWebAssembly.tf.setWechatFetch(TTWebAssembly)
	TTWebAssembly.atob=atobPolyfill
